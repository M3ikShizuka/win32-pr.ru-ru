---
title: Уведомления списка
description: Уведомления списка
...
ms.locfileid: "127174248"
---
# <a name="list-box-notifications"></a>Уведомления списка

## <a name="in-this-section"></a>в этом разделе

-   [бегиндраг списка рассылки \_](dl-begindrag.md)
-   [канцелдраг списка рассылки \_](dl-canceldrag.md)
-   [\_перетаскивание DL](dl-dragging.md)
-   [DL \_ удален](dl-dropped.md)
-   [ЛБН \_ дблклк](lbn-dblclk.md)
-   [ЛБН \_ еррспаце](lbn-errspace.md)
