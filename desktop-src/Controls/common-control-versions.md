...
поддержка стандартных элементов управления обеспечивается ComCtl32.dll, все 32-разрядные и 64-разрядные версии Windows включают. Каждая последовательная версия библиотеки DLL поддерживает функции и API более ранних версий и добавляет новые функции.
...
Windows сервер 2003, Windows Vista, Windows Server 2008 и Windows 7
...
Чтобы обеспечить совместимость приложения с различными целевыми версиями файла .dll, в файлах заголовков содержатся макросы версии. Эти макросы используются для определения, исключения или переопределения определенных определений для различных версий библиотеки DLL. подробное описание этих макросов см. в разделе [использование Windows заголовков](/windows/desktop/WinProg/using-the-windows-headers) .
