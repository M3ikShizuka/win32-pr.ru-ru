...
Для приложения ANSI система преобразует текст в поле со списком в Юникод, используя кодовую страницу **CP \_ ACP** . Это может вызвать проблемы. например, римские символы с диакритическими знаками в списке не в юникоде в Windows, версия японской версии не будет искажена. Чтобы устранить эту проблему, либо скомпилируйте приложение как Юникод, либо используйте список, рисуемый владельцем.
