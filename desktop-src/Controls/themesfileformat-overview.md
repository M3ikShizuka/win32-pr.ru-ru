...
| attribute | Описание | 
|-----------|-------------|
| Интервал = число миллисекунд | Обязательный элемент. Интервал — это число, определяющее частоту изменения фона. Измеряется в миллисекундах. | 
| Случайный = 0 или 1 | Обязательный элемент. Случайный выбор в случайном порядке определяет фоновый режим.<br /> 0 = отключено<br /> 1 = включено<br /> | 
