...
для отключения от логического датчика необходимо указать тот же логический идентификатор, который использовался при вызове [**Подключение**](/previous-versions/windows/desktop/legacy/dd374029(v=vs.85)).
...
чтобы удалить логический датчик, необходимо указать тот же логический идентификатор, который использовался при вызове [**Подключение**](/previous-versions/windows/desktop/legacy/dd374029(v=vs.85)).
