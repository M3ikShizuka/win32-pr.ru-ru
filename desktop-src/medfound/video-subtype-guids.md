...
| GUID                    | Формат | Выборка | Упакованная или плоская | Бит на канал |
|-------------------------|--------|----------|------------------|------------------|
...
| **Мфвидеоформат \_ MSS1**     | 'MSS1'         | Windows Экранный кодек Media версии 1.                                                                                                                                                                                                                                                                       |
| **Мфвидеоформат \_ MSS2**     | 'MSS2'         | Windows Экранный кодек Media видео 9.                                                                                                                                                                                                                                                                         |
| **Мфвидеоформат \_ WMV1**     | 'WMV1'         | Windows Мультимедийный кодек версии 7.                                                                                                                                                                                                                                                                        |
| **Мфвидеоформат \_ WMV2**     | 'WMV2'         | Windows Кодек Media Video 8.                                                                                                                                                                                                                                                                                |
| **Мфвидеоформат \_ WMV3**     | 'WMV3'         | Windows Кодек Media Video 9.                                                                                                                                                                                                                                                                                |
...
> [!Note]  
> DirectShow также использует эту систему для большинства подтипов видео, но не для несжатых форматов RGB. таким образом, подтипы rgb в DirectShow не соответствуют подтипам rgb в Media Foundation.
