...
ms.locfileid: "127461992"
---
# <a name="protectedplayback-sample"></a>Пример Протектедплайбакк

Показывает, как воспроизвести защищенное содержимое мультимедиа в Microsoft Media Foundation.
...
[Пример Мфплайер](/previous-versions//bb970516(v=vs.85))
</dt> </dl>
