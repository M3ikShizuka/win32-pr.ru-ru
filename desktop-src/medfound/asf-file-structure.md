...
ms.locfileid: "127461022"
---
# <a name="asf-file-structure"></a>Структура файла ASF

В этом разделе описывается структура файла в формате ASF.

Чтобы получить подробные сведения о файлах ASF, скачайте [спецификацию ASF](https://www.microsoft.com/downloads/details.aspx?displaylang=en&FamilyID=56de5ee4-51ca-46c6-903b-97390ad14fea). для просмотра структуры существующего файла asf можно также использовать средство [Windows Media ASF Viewer 9 Series](https://www.microsoft.com/downloads/details.aspx?displaylang=en&FamilyID=56de5ee4-51ca-46c6-903b-97390ad14fea) .
