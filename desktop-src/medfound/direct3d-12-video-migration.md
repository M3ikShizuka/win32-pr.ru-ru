...
| [креатевидеопроцессоренумератор](/windows/win32/api/d3d11/nf-d3d11-id3d11videodevice-createvideoprocessorenumerator) | Недоступно |
...
| [жетвидеодекодерконфигкаунт](/windows/win32/api/d3d11/nf-d3d11-id3d11videodevice-getvideodecoderconfigcount) | Недоступно |
