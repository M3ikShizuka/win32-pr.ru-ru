...
правильный способ получения указателя на интерфейс [**имфвидеодисплайконтрол**](/windows/desktop/api/evr/nn-evr-imfvideodisplaycontrol) зависит от того, используется ли DirectShowная версия евр или версия Media Foundation. Для Media Foundation Евр это также зависит от того, используется ли Евр напрямую или с помощью сеанса мультимедиа (что является более типичным).
