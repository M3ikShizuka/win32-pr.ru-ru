...
ms.locfileid: "127459342"
---
# <a name="drm_actionallowed_copytocd"></a>\_Актионалловед \_ копитокд DRM

Атрибут **DRM \_ актионалловед \_ копитокд** указывает, разрешено ли копирование содержимого на компакт-диск.

## <a name="global-constant"></a>Глобальная константа

g \_ всзвмдрм \_ актионалловед \_ копитокд
