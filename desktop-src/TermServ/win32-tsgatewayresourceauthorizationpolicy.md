...
| [**DELETE**](delete-win32-tsgatewayresourceauthorizationpolicy.md)                             | Удаляет текущую политику авторизации ресурсов удаленных рабочих столов.<br/>                                                                              |
