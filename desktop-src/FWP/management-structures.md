...
description: Структуры управления
...
-   [**ФВПМ \_ net \_ EVENT0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event0)
-   [**ФВПМ \_ net \_ EVENT1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event1)
-   [**ФВПМ \_ net \_ EVENT2**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event2)
-   [**ФВПМ \_ net \_ EVENT3**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event3)
...
-   [**ФВПМ \_ net \_ event \_ классифицировать \_ DROP0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_classify_drop0)
-   [**ФВПМ \_ net \_ event \_ классифицировать \_ DROP1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_classify_drop1)
...
-   [**ФВПМ \_ net \_ event \_ HEADER0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_header0)
-   [**ФВПМ \_ net \_ event \_ HEADER1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_header1)
-   [**ФВПМ \_ net \_ event \_ HEADER2**](/windows/win32/api/fwpmtypes/ns-fwpmtypes-fwpm_net_event_header2)
-   [**ФВПМ \_ net \_ event \_ HEADER3**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_header3)
-   [**ФВПМ \_ net \_ event \_ IKEEXT \_ EM \_ FAILURE0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_ikeext_em_failure0)
-   [**ФВПМ \_ net \_ event \_ IKEEXT \_ EM \_ FAILURE1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_ikeext_em_failure1)
-   [**ФВПМ \_ net \_ event \_ IKEEXT \_ mm \_ FAILURE0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_ikeext_mm_failure0)
-   [**ФВПМ \_ net \_ event \_ IKEEXT \_ mm \_ FAILURE1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_ikeext_mm_failure1)
...
-   [**\_CONTEXT0 поставщика \_ фвпм**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_provider_context0)
-   [**ФВПМ \_ поставщика \_**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_provider_context1)
