---
description: Содержит событие архитектуры проверки компьютера (MCA). этот класс доступен только в 64-разрядных Windows системах.
...
ms.locfileid: "127568106"
---
# <a name="msmcainfo_rawmcaevent-class"></a>\_Класс мсмкаинфо равмкаевент

Класс **мсмкаинфо \_ равмкаевент** содержит событие архитектура проверки компьютера (MCA). этот класс доступен только в 64-разрядных Windows системах.
