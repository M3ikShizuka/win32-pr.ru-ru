...
ms.locfileid: "126889224"
---
# <a name="wmireverttopolicybrightness-method-of-the-wmimonitorbrightnessmethods-class"></a>Метод Вмиреверттополицибригхтнесс класса Вмимониторбригхтнессмесодс

Метод **вмиреверттополицибригхтнесс** используется для возврата яркости к параметру политики. Этот метод не влияет на настройки яркости Кроме.
