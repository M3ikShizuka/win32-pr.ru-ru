---
description: Указывает на ошибку компонента PCI об архитектуре проверки компьютеров (MCA). этот класс доступен только в 64-разрядных Windows системах.
...
ms.locfileid: "127342467"
---
# <a name="msmcaevent_pcicomponenterror-class"></a>\_Класс мсмкаевент пЦикомпонентеррор

Класс **мсмкаевент \_ пЦикомпонентеррор** указывает на ошибку компонента PCI "архитектура проверки машин" (MCA). этот класс доступен только в 64-разрядных Windows системах.
