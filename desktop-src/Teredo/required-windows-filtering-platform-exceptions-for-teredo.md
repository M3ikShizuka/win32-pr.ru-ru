---
title: Windows Фильтрация исключений платформы для Teredo
description: исключения, позволяющие приложениям получать незапрошенный трафик через Teredo через брандмауэр, должны создаваться с помощью интерфейсов api платформы Windows фильтрации.
...
ms.locfileid: "127243541"
---
# <a name="windows-filtering-platform-exceptions-for-teredo"></a>Windows Фильтрация исключений платформы для Teredo

исключения, позволяющие приложениям получать незапрошенный трафик через [Teredo](about-teredo.md) через брандмауэр, должны создаваться с помощью интерфейсов api [платформы Windows фильтрации](/windows/desktop/FWP/windows-filtering-platform-start-page) . Это достигается путем открытия входящих и исходящих исключений на основе приложений (приложения <app name> ) в подуровне Teredo для трафика IPv6. Это гарантирует, что только приложения с исключением Teredo могут использовать Teredo. Следует соблюдать осторожность при создании этих исключений. Использование общего \* параметра "" (все) может позволить программам, не зарегистрированным в подуровне Teredo или туннельный трафик, передавать брандмауэр и представлять угрозу безопасности.
