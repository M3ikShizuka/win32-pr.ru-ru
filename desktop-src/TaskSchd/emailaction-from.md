...
ms.locfileid: "127066909"
---
# <a name="emailactionfrom-property"></a>Емаилактион. from, свойство
...
Для создания скриптов Возвращает или задает адрес электронной почты, по которому нужно отправить электронное письмо.
...
Адрес электронной почты, с которого вы хотите отправить электронное письмо.
