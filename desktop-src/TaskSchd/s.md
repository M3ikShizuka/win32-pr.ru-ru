...
ms.locfileid: "126886549"
---
# <a name="s-task-scheduler"></a>S (планировщик задач)

A B C D [E](e.md) F G р [. J K](i.md) L M N O [P](p.md) Q R S [T](t.md) U V [W](w.md) X Y Z

<dl> <dt>

<span id="_msb_scheduled_tasks_folder_gly"></span><span id="_MSB_SCHEDULED_TASKS_FOLDER_GLY"></span>**Папка запланированных задач**
</dt> <dd>
