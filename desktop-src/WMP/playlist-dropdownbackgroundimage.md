---
title: Список воспроизведения. Дропдовнбаккграундимаже
...
ms.locfileid: "127458431"
---
# <a name="playlistdropdownbackgroundimage"></a>Список воспроизведения. Дропдовнбаккграундимаже

Атрибут **дропдовнбаккграундимаже** указывает или получает имя изображения, которое отображается в фоновом режиме раскрывающегося списка.
