...
keywords:
- подключаемые модули проигрыватель Windows Media, параметры
...
подключаемый модуль пользовательского интерфейса может быть настроен на автоматическую загрузку после установки при запуске проигрыватель Windows Media. Если он не запускается автоматически, пользователь может загрузить его, выбрав его из списка **подключаемые модули** в меню **Сервис** .
