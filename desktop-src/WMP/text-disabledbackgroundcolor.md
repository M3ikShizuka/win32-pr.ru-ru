---
title: TEXT. Дисабледбаккграундколор
...
Атрибут **дисабледбаккграундколор** указывает или получает цвет фона, используемый для элемента управления "текст", когда он отключен.
