...
Событие Плайлистколлектионплайлистсетасделетед зарезервировано для будущего использования.
...
Обработчик, связанный с этим событием, имеет тип **аксвмплиб. \_ Вмпокксевентс \_ плайлистколлектионплайлистсетасделетедевенсандлер**. Этот обработчик получает аргумент типа **аксвмплиб. \_ Вмпокксевентс \_ плайлистколлектионплайлистсетасделетедевент**, который содержит следующие свойства, связанные с этим событием.



| Свойство         | Описание                                 |
|------------------|---------------------------------------------|
| бстрплайлистнаме | **System. String** Не поддерживается.<br/>  |
| варфисделетед    | **System. Boolean** Не поддерживается.<br/> |
