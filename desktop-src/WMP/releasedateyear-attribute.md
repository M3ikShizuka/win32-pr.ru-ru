---
title: Атрибут Релеаседатэйеар
description: Атрибут Релеаседатэйеар — это часть даты исходного выпуска элемента.
ms.assetid: e211d5ed-b337-4c34-9abe-03cc1ab92b81
keywords:
- проигрыватель Windows Media атрибута релеаседатэйеар
topic_type:
- apiref
api_name:
- ReleaseDateYear
...
Атрибут **релеаседатэйеар** — это часть даты исходного выпуска элемента.
