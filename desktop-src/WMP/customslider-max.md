...
keywords:
- кустомслидер. max проигрыватель Windows Media
topic_type:
- apiref
api_name:
- CUSTOMSLIDER.max
...
ms.locfileid: "127258832"
---
# <a name="customslidermax"></a>КУСТОМСЛИДЕР. Max

Атрибут **Max** указывает или получает максимальное значение диапазона, определенного настраиваемым ползунком.
...
[**КУСТОМСЛИДЕР. min**](customslider-min.md)
</dt> </dl>
