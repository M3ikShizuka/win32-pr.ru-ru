...
keywords:
- амбиентаттрибутес. tabStop проигрыватель Windows Media
topic_type:
- apiref
api_name:
...
| Значение | Описание                                                                                |
|-------|--------------------------------------------------------------------------------------------|
| Да  | Элемент управления находится в порядке перехода (элемент управления будет иметь позицию табуляции: требование специальных возможностей). |
