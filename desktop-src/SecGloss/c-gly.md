...
Windowsная конструкция, которая позволяет профилировать сертификаты (то есть формат и содержимое) на основе их предполагаемого использования. при запросе [*сертификата*](/windows) из *центра сертификации* (цс) Windows предприятия инициаторы запроса сертификатов, в зависимости от прав доступа, могут выбирать из множества типов сертификатов, основанных на шаблонах сертификатов, таких как подпись пользователя и кода.
...
прикладной программный интерфейс, позволяющий разработчикам приложений добавлять в приложения на основе Windows проверку подлинности, кодирование и шифрование.
