...
| -Mod      | Обязательный. Указывает режим системы записи голоса. дополнительные сведения см. в подразделе "настройка записи голоса DMO" в образце файла readme. |
