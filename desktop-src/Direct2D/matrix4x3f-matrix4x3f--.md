---
title: Конструктор Matrix4x3F Matrix4x3F () (D2d1 \_ Helper. h)
description: Создает новый экземпляр неинициализированного класса Matrix4x3F.
...
ms.locfileid: "127162699"
---
# <a name="matrix4x3fmatrix4x3f-constructor"></a>Конструктор Matrix4x3F:: Matrix4x3F ()

Создает новый экземпляр неинициализированного класса [**Matrix4x3F**](matrix4x3f.md) .
