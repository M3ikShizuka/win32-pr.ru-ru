...
|------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Color<br/> \_ \_ Цвет Prop D2D1 \_ Flood<br/> | Цвет и непрозрачность точечного рисунка. Это свойство является D2D1 \_ векторным \_ 4Fом. Отдельные значения для каждого канала имеют тип FLOAT, без привязки и без единицы. Этот результат не изменяет значения для каналов.<br/> Значения RGBA для каждого канала в диапазоне от 0 до 1.<br/> Тип — D2D1 \_ vector \_ 4F.<br/> Значение по умолчанию — {0.0 f, 0,0 f, 0,0 f, 1,0 f}.<br/> |
