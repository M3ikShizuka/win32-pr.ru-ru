...
| Вызовите [**креатевссексаминевритерметадата**](/windows/desktop/api/VsBackup/nf-vsbackup-createvssexaminewritermetadata) , чтобы создать интерфейсы [**ивссексаминевритерметадата**](/windows/desktop/api/VsBackup/nl-vsbackup-ivssexaminewritermetadata) и загрузить их с помощью хранимых метаданных модуля записи.                                                                                                           | None                                                      | None                                                                                                                                                                                                                                                                                                                      |
...
| Инициатор запроса ожидает инициализации модулей записи путем вызова [**ивссасинк**](/windows/desktop/api/Vss/nn-vss-ivssasync).                                                                                                                                                                                                                               | None                                                      | Нет                                                                                                                                                                                                                                                                                                                      |
