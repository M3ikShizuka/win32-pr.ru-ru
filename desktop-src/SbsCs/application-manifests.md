...
Элемент контейнера. Его первым подэлементом должен быть элемент **NoInherit** или **assemblyIdentity** . Обязательный элемент.
...
| attribute                 | Описание                                                                                                                                                                                                                                                                                                                                                                                                                       |
|---------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **type**                  | Указывает тип приложения или сборки. Значение должно быть в виде Win32, а все — в нижнем регистре. Обязательный элемент.                                                                                                                                                                                                                                                                                                                              |
| **name**                  | Уникально именует приложение или сборку. Используйте следующий формат для имени: Organization.Division.Name. Например, Microsoft. Windows. мисамплеапп. Обязательный элемент.                                                                                                                                                                                                                                                               |
| **language**              | Определяет язык приложения или сборки. Необязательный параметр. Если приложение или сборка зависит от языка, укажите код языка DHTML. На **теге assemblyIdentity** приложения, предназначенного для международных использования (не зависит от языка), не указывайте атрибут Language.<br/> В **теге assemblyIdentity** сборки, предназначенной для международных использования (нейтральный к языку), задайте для параметра Language значение " \* ".<br/> |
| **processorArchitecture** | Указывает процессор. Допустимые значения: `x86`, `amd64`, `arm` и `arm64`. Необязательный элемент.                                                                                                                                                                                                                                                                                                                       |
| **version**               | Указывает версию приложения или сборки. Используйте формат версии из четырех частей: оближешь. nnnnn. ууо. ппппп. Каждая из частей, разделенных точками, может быть 0-65535 включительно. Дополнительные сведения см. в разделе [версии сборки](assembly-versions.md). Обязательный элемент.                                                                                                                                                                        |
...
Содержит по крайней мере одно **приложение**. У него нет атрибутов. Необязательный параметр. манифесты приложений без элемента compatibility по умолчанию Windows совместимость с Vista на Windows 7.

<span id="application"></span><span id="APPLICATION"></span>

### <a name="application"></a>application

Содержит по крайней мере один элемент **суппортедос** . начиная с Windows 10 версии 1903, она также может содержать один необязательный элемент **maxversiontested укажите установленную** . У него нет атрибутов. Необязательный параметр.
...
Указывает файлы, являющиеся частными для приложения. Необязательный параметр.
