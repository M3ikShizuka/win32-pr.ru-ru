...
| Метод                                                    | Описание                                                      |
|:----------------------------------------------------------|:-----------------------------------------------------------------|
| [**Создать**](create-win32-clustershare.md)               | Создает новый экземпляр **Win32 \_ клустершаре** .<br/>       |
| [**Удаление**](delete-win32-clustershare.md)               | Удаляет экземпляр **Win32 \_ клустершаре** .<br/>           |
