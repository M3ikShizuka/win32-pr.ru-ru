...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP1 \_ без подключения")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ — гарантированная \_ доставка")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ гарантированный \_ порядок")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| имакссоккаддр"), [**единицы**](../wmisdk/standard-qualifiers.md) ("символы")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двмессажесизе"), [**единицы**](../wmisdk/standard-qualifiers.md) ("символы")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс XP с ориентацией на \| \_ сообщения \_ ")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| иминсоккаддр"), [**единицы**](../wmisdk/standard-qualifiers.md) ("символы")
</dt> </dl>
...
квалификаторы: [**ключ**](../wmisdk/key-qualifier.md), [**переопределение**](../wmisdk/standard-qualifiers.md) ("имя"), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты, \| сведения о протоколе \_ \| лппротокол")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ псевдо \_ -STREAM")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ поддерживает \_ трансляцию")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ CONNECT \_ DATA")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ DISCONNECT \_ DATA")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ encrypted")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ \_ ")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ ")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс XP, \| \_ \_ близкое к закрытию")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе двсервицефлагс, \| \| \_ распределение пропускной способности XP \_ ")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \_ API Win32 \| Windows сокеты структуры \| \_ сведения о протоколе \| двсервицефлагс \| XP \_ поддерживает \_ многоадресную рассылку")
</dt> </dl>
...
квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32 \_ API \| Windows структуры сокетов \| всапротокол \_ INFO \| dwServiceFlags1 \| XP1 \_ QOS \_ supported")
</dt> </dl>
