...
ms.locfileid: "127053720"
---
# <a name="win32_systemaccount-class"></a>\_Класс Win32 SystemAccount

Класс **WMI \_ SystemAccount** [инструментария](../wmisdk/retrieving-a-class.md) Win32 представляет системную учетную запись. Системная учетная запись используется операционной системой и службами. существует множество служб и процессов в Windows, которым требуется возможность внутреннего входа в систему, например во время установки Windows. Системная учетная запись была разработана для этой цели.
