---
description: представляет задание печати, созданное Windows приложением. любая единица работы, созданная командой print приложения, работающей на компьютере, работающем на Windows операционной системе, является потомком или членом этого класса.
...
ms.locfileid: "127174383"
---
# <a name="win32_printjob-class"></a>\_Класс Win32 PrintJob

[класс WMI](../wmisdk/retrieving-a-class.md) для **Win32 \_ PrintJob** представляет задание печати, созданное Windows приложением. любая единица работы, созданная командой print приложения, работающей на компьютере, работающем на Windows операционной системе, является потомком или членом этого класса.
...
| [**Выход**](resume-method-in-class-win32-printjob.md) | Возобновляет задание печати.<br/> |
...
Формат данных для этого задания печати. это указывает драйверу принтера преобразовать данные (универсальный текст, PostScript или PCL) перед печатью или распечатать в необработанном формате (для графики и изображений).
