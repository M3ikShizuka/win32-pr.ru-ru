...
*маленький значок оболочки* используется в обозревателе Windows и общих диалоговых окнах. В настоящее время по умолчанию используется малый размер системы.
...
в меню используются маленькие значки оболочки или крупные значки оболочки в зависимости от того, установлен ли флажок **использовать крупные значки** .
