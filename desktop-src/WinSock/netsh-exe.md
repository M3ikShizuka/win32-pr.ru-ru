...
Документация по всем командам **netsh** для IPv6 также доступна в Интернете на сайте TechNet. дополнительные сведения о **netsh** на Windows Server 2008 см. в разделе [команды netsh для интерфейса (IPv4 и IPv6)](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc770948(v=ws.10)). дополнительные сведения о **netsh** на Windows Server 2003 см. в разделе [команды netsh для интерфейса IPv6](/previous-versions/windows/it-pro/windows-server-2003/cc740203(v=ws.10)).
