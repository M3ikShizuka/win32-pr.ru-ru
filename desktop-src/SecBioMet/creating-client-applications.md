...
keywords:
- Windows api биометрическая платформа Windows api биометрической платформы, клиентские приложения
ms.topic: article
ms.date: 05/31/2018
...
поставщик учетных данных и диспетчер учетных данных являются компонентами в биометрическая платформа Windows. Поставщик получает учетные данные пользователя из безопасного хранилища и реагирует на запросы на повышение прав входа, разблокировки, изменения пароля и контроля учетных записей. Он также отвечает во время быстрого переключения пользователя для входа нового пользователя. Диспетчер сопоставляет учетные данные входа для биометрических удостоверений и безопасно сохраняет учетные данные. сопоставления, как правило, создаются сторонними приложениями регистрации во время биометрической регистрации, но их также можно создать с помощью Windows биометрического поставщика учетных данных при входе в систему, если зарегистрированный пользователь пытается выполнить проверку правильности, но либо не зарегистрирован, либо учетные данные не совпадают с параметрами в безопасном хранилище.
