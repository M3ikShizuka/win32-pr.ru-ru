---
title: Константы WINBIO_ANSI_381_IMG_ACQ (Винбио \_ types. h)
description: Укажите уровни получения изображений.
...
Для указания уровней получения изображений можно использовать следующие константы:
