...
3.  на вкладке **Параметры** в окне **текстовые службы и языки ввода** нажмите кнопку **добавить**. Выберите нужную службу текстового ввода из появившегося списка. Выбранная служба текстового ввода появится в следующем окне под соответствующим языком.
    ...
    Если языковая панель видима, можно быстро добавить или удалить текстовую службу, как показано ниже. щелкните правой кнопкой мыши языковую панель и выберите **Параметры** или нажмите кнопку **параметры** ![ на панели язык на ](images/options-btn.gif) правой стороне языковой панели и выберите **Параметры**. Затем добавьте или удалите текстовую службу, как описано в шаге 3.
