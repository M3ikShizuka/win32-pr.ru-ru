---
description: Метод SWbemServices. ExecQuery — выполняет запрос для получения объектов.
ms.assetid: 06b9d4c9-cd72-49b2-92b0-d18d94dfbd9f
ms.tgt_platform: multiple
title: Метод SWbemServices. ExecQuery (Wbemdisp. h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "126971429"
---
# <a name="swbemservicesexecquery-method"></a>SWbemServices. ExecQuery, метод
