...
Для журналов событий с большим количеством записей разница во времени обработки может быть значительной. на тестовом компьютере на базе Windows 2000 с 2 000 записями в журнале событий синхронный запрос, извлекающий все события и отображаемый в командном окне, занял 10 минут 45 секунд. Асинхронный запрос, выполняющий одну и ту же операцию, занял одну минуту 54 секунд.
