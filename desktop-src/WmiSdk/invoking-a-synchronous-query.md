...
1.  Опишите запрос к WMI с помощью [**SwbemServices. ExecQuery**](swbemservices-execquery.md). Этот метод возвращает [**SWbemObjectSet**](swbemobjectset.md).
