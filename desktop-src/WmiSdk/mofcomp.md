...
Необязательный параметр. Извлекает локализованные описания MOF из двоичного MOF при использовании с параметром-ER.
