...
следующий моникер задает уровень олицетворения для олицетворения и задает SE \_ привилегии отладки.
...
следующий моникер задает уровень олицетворения для олицетворения и задает SE \_ привилегии отладки. он также отменяет \_ привилегию SE завершения работы.
