...
Обязательный элемент. Приемник объекта, который получает объекты асинхронно. Создайте объект [**свбемсинк**](swbemsink.md) для получения объектов.
