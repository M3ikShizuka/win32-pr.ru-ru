...
| [**Элемент Property\_**](swbemlasterror-properties-.md)<br/> | Только для чтения<br/> | Представляет коллекцию свойств объекта **свбемластеррор** . Это свойство является объектом [**SWbemPropertySet**](swbempropertyset.md) .<br/> |
| **Квалификаторы\_**<br/>                                   | Только для чтения<br/> | Не используется. Объект [**SWbemObject**](swbemobject.md) предоставляет тот же метод.<br/>                                                                  |
| **Бюллетеня\_**<br/>                                     | Только для чтения<br/> | Не используется. Объект [**SWbemObject**](swbemobject.md) предоставляет тот же метод.<br/>                                                                  |
