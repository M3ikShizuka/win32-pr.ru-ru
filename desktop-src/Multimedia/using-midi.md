---
title: Использование MIDI
description: Использование MIDI
...
- Цифровой интерфейс музыкальных инструментов (MIDI), примеры
...
-   [Использование секвенсора MIDI MCI](using-the-mci-midi-sequencer.md)
-   [Использование Мидиаутшортмсг для отправки отдельных сообщений MIDI](using-midioutshortmsg-to-send-individual-midi-messages.md)
