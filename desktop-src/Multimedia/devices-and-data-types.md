...
| Прочее                    | Каждый пример содержится в блоке, который имеет кратное 4 байта, но примеры могут быть не выходящими по байтам. Расположение каналов задается маской. Дополнительные сведения см. в разделе [**вавеформатекстенсибле**](/windows/win32/api/mmreg/ns-mmreg-waveformatextensible).                                                                                                 |
