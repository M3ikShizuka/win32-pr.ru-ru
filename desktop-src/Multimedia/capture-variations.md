---
title: Варианты захвата
description: Варианты захвата
...
ms.locfileid: "127147538"
---
# <a name="capture-variations"></a>Варианты захвата

Помимо потоковой записи на основе постоянного интервала времени Авикап поддерживает следующие типы записи:
