...
|------------------------|-------------------------------------|----------------------------------------|
| [**break**](break.md) | [**\_разрыв MCI**](mci-break.md)     | Задает ключ разрыва для устройства MCI.    |
...
| [**сведения**](info.md)             | [**\_сведения о MCI**](mci-info.md)             | Получает текстовые данные с устройства.                                                                                |
...
| [**set**](set.md)       | [**\_набор MCI**](mci-set.md)       | Задает рабочее состояние устройства.                                                                                                                                                                                                 |
...
| [**сказк**](cue.md)             | [**\_Подсказка MCI**](mci-cue.md)             | дигиталвидео, вавеаудио | Готовится к воспроизведению или записи.                                                                |
