...
| Расширения                             | Указывает расширение файла (в этом примере —. WAV), которую обработчик файлов может обработать.             |
