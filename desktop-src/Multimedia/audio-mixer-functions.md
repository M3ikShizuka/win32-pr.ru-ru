---
title: функции аудио Mixer
description: функции аудио Mixer
ms.assetid: 19f53a98-1a01-4954-a5d7-c428aa2bfa38
keywords:
- мультимедиа аудио, функции микшера звука
- аудио, функции микшера звука
- мультимедиа аудио, функции микшера
- аудио, функции микшера
- Audio миксерс, функции
- миксерс, функции
- Справочник по Audio миксерс, функции
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "124371970"
---
# <a name="audio-mixer-functions"></a>функции аудио Mixer

С Audio миксерс используются следующие функции.
