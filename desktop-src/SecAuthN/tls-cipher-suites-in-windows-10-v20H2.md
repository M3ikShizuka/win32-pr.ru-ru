---
description: узнайте о комплектах шифров TLS в Windows 10 v20H2 и v21H1. Комплекты шифров можно согласовать только для тех версий TLS, которые их поддерживают.
title: комплекты шифров TLS в Windows 10 v20H2 и v21H1
ms.topic: article
ms.date: 09/01/2021
...
ms.locfileid: "127568554"
---
# <a name="tls-cipher-suites-in-windows-10-v20h2-and-v21h1"></a>комплекты шифров TLS в Windows 10 v20H2 и v21H1
...
для Windows 10 версии v20H2 и v21H1 следующие комплекты шифров включены и по умолчанию в этом порядке используют поставщик Microsoft Schannel:
