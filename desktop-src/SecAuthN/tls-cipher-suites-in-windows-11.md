---
description: узнайте о комплектах шифров TLS в Windows 11. Комплекты шифров можно согласовать только для тех версий TLS, которые их поддерживают.
title: комплекты шифров TLS в Windows 11.
ms.topic: article
ms.date: 09/01/2021
...
ms.locfileid: "127568551"
---
# <a name="tls-cipher-suites-in-windows-11"></a>комплекты шифров TLS в Windows 11
...
для Windows 11 следующие комплекты шифров включены и в этом порядке по умолчанию используют поставщик Microsoft Schannel:
