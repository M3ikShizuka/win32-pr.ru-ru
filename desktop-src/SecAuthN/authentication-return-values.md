...
> [!Note]  
> некоторые возвращаемые значения могут иметь то же значение, что и существующие Windows возвращаемые значения, которые обозначают аналогичное условие. Дополнительные сведения о кодах ошибок, не перечисленных здесь, см. в разделе [коды системных ошибок](/windows/desktop/Debug/system-error-codes).
