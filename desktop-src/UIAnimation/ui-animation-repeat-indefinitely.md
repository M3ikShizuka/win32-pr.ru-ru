...
Указывает, что интервал между двумя опорными кадрами в раскадровке должен повторяться бессрочно, пока не будет вызван метод [**иуианиматионсторибоард:: заключение**](/windows/desktop/api/UIAnimation/nf-uianimation-iuianimationstoryboard-conclude) .



| Константа/значение                                                                                                                                                                                                                                                                   | Описание      |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
| <span id="UI_ANIMATION_REPEAT_INDEFINITELY"></span><span id="ui_animation_repeat_indefinitely"></span><dl> <dt>**Пользовательский интерфейс \_ \_ \_ Время анимации повтора**</dt> <dt>— 1</dt> </dl> | INT32<br/> |
...
[**Иуианиматионсторибоард:: Репеатбетвинкэйфрамес**](/windows/desktop/api/UIAnimation/nf-uianimation-iuianimationstoryboard-repeatbetweenkeyframes)
</dt> </dl>
