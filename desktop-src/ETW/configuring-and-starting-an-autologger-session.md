...
| <strong>Guid</strong> | <strong>REG_SZ</strong> | Строка, содержащая идентификатор GUID, однозначно определяющий сеанс. Это значение обязательно. | 
...
| Значение | Тип | Описание | 
|-------|------|-------------|
| <strong>Enabled</strong> | <strong>REG_DWORD</strong> | Определяет, включен ли поставщик. Чтобы включить поставщик, присвойте этому параметру значение 1. Чтобы отключить поставщик, присвойте этому параметру значение 0. Значение по умолчанию равно 0. | 
