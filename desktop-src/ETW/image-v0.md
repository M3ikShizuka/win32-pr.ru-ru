...
ms.locfileid: "127470346"
---
# <a name="image_v0-class"></a>\_Класс Image v0

Этот класс является родительским для событий загрузки изображения.
...
Класс **image \_ v0** не определяет никаких членов.
