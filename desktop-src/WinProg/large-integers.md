...
description: Большие целочисленные функции и структуры изначально поддерживали 64-разрядные значения на 32-бит Windows.
...
ms.locfileid: "127347674"
---
# <a name="large-integers"></a>Большие целые числа

Большие целочисленные функции и структуры изначально поддерживали 64-разрядные значения на 32-бит Windows. Теперь компилятор C может поддерживать 64-разрядные целые числа в собственном коде. например, Microsoft Visual C++ поддерживает целочисленный тип с размером [**\_ \_ int64**](/windows/desktop/Midl/--int64) . Дополнительные сведения см. в документации, входящей в состав компилятора C.

сведения о 64-разрядных целых числах в 64-разрядной Windows см. [в разделе новые типы данных](/windows/desktop/WinProg64/the-new-data-types).
