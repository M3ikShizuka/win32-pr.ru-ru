...
для 32-разрядных Windows существует два соглашения о вызовах для эффективной передачи значений [ \_ \_ m128](/cpp/cpp/m128) (которые реализуют [**ксмвектор**](xmvector-data-type.md) на этой платформе). Стандартом является [ \_ \_ fastcall](/cpp/cpp/fastcall), который может передавать первые три значения [ \_ \_ M128](/cpp/cpp/m128) (экземпляры **ксмвектор** ) в качестве аргументов в функцию в регистре *SSE/SSE2* . [ \_ \_ fastcall](/cpp/cpp/fastcall) передает оставшиеся аргументы через стек.
...
для 64-разрядных Windows для эффективной передачи значений [ \_ \_ m128](/cpp/cpp/m128) доступны два соглашения о вызовах. Стандартом является [ \_ \_ fastcall](/cpp/cpp/fastcall), который передает все значения [ \_ \_ M128](/cpp/cpp/m128) в стеке.
