---
description: Столбцы таблиц базы данных форматируются в одном из следующих типов данных.
...
-   [Время и Дата](time-date.md)
-   [Идентификатор](identifier.md)
-   [Свойство](property.md)
-   [Имя файла](filename.md)
-   [вилдкардфиленаме](wildcardfilename.md)
-   [Путь](path.md)
-   [Пути](paths.md)
-   [анипас](anypath.md)
-   [дефаултдир](defaultdir.md)
-   [регпас](regpath.md)
