---
description: Контекст продукта.
ms.assetid: e8848e99-452d-4ea7-830b-7af7f32f8390
title: Свойство Client. Context
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127142481"
---
# <a name="clientcontext-property"></a>Свойство Client. Context

Контекст продукта. Это свойство вызывает функцию [**мсиенумклиентсекс**](/windows/desktop/api/Msi/nf-msi-msienumclientsexa) .
