...
| [**Commit**](database-commit.md)                                         | Завершает постоянную форму базы данных.<br/>                                                                                                                 |
...
| [**Объединить**](database-merge.md)                                           | Объединяет эталонную базу данных с базовой базой данных.<br/>                                                                                                          |
