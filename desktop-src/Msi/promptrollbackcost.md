...
| Значение | Действие                                                              |
|-------|---------------------------------------------------------------------|
| P     | Отображение диалогового окна с вопросом, следует ли продолжить без отката. |
| D     | Отключите откат и продолжайте, не запрашивая пользователя.                  |
| F     | Завершается с запросом об ошибке нехватки места на диске.                       |
