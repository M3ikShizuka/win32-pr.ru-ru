---
description: 'Дополнительные сведения: перечисление JET_InstanceMiscInfo'
title: Перечисление JET_InstanceMiscInfo (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "126964305"
---
# <a name="jet_instancemiscinfo-enumeration"></a>Перечисление JET_InstanceMiscInfo

Уровни информации для [жетжетинстанцемисЦинфо (JET_INSTANCE, JET_SIGNATURE, JET_InstanceMiscInfo)](./vistaapi.jetgetinstancemiscinfo-method.md).
...
<td></td>
<td>логсигнатуре</td>
<td>Получить подпись журнала транзакций, связанного с этой последовательностью.</td>
</tr>
</tbody>
</table>
