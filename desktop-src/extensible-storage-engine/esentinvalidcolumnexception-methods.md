---
description: 'Дополнительные сведения: методы Есентинвалидколумнексцептион'
title: Методы Есентинвалидколумнексцептион
...
ms.locfileid: "127345238"
---
# <a name="esentinvalidcolumnexception-methods"></a>Методы Есентинвалидколумнексцептион
