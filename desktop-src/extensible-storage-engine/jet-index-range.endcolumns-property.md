---
description: 'Дополнительные сведения о свойстве: JET_INDEX_RANGE. Ендколумнс'
title: Свойство JET_INDEX_RANGE. Ендколумнс (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "119110085"
---
# <a name="jet_index_rangeendcolumns-property"></a>Свойство JET_INDEX_RANGE. Ендколумнс

Возвращает или задает значения столбцов для конца индекса.
