---
description: 'Дополнительные сведения о: JET_RSTINFO. Метод ToString'
title: JET_RSTINFO. Метод ToString
...
ms.locfileid: "126965566"
---
# <a name="jet_rstinfotostring-method"></a>JET_RSTINFO. Метод ToString

Возвращает [строку](/dotnet/api/system.string) , представляющую текущий [JET_RSTINFO](./jet-rstinfo-class.md).
