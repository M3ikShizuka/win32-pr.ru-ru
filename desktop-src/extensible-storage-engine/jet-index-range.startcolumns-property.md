---
description: 'Дополнительные сведения о свойстве: JET_INDEX_RANGE. Стартколумнс'
title: Свойство JET_INDEX_RANGE. Стартколумнс (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "127346707"
---
# <a name="jet_index_rangestartcolumns-property"></a>Свойство JET_INDEX_RANGE. Стартколумнс

Возвращает или задает значения столбцов для начала индекса.
...
[Элементы JET_INDEX_RANGE](./jet-index-range-members.md)
