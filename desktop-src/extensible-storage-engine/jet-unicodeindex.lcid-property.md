...
ms.locfileid: "126965557"
---
# <a name="jet_unicodeindexlcid-property"></a>JET_UNICODEINDEX. LCID, свойство

Возвращает или задает код языка, используемый при нормализации данных в Юникоде.
