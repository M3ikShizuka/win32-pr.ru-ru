---
description: 'Дополнительные сведения о: конструктор EsentMustCommitDistributedTransactionToLevel0Exception'
title: Конструктор EsentMustCommitDistributedTransactionToLevel0Exception
...
ms.locfileid: "127174652"
---
# <a name="esentmustcommitdistributedtransactiontolevel0exception-constructor"></a>Конструктор EsentMustCommitDistributedTransactionToLevel0Exception

Инициализирует новый экземпляр класса EsentMustCommitDistributedTransactionToLevel0Exception.
...
[Элементы EsentMustCommitDistributedTransactionToLevel0Exception](./esentmustcommitdistributedtransactiontolevel0exception-members.md)
