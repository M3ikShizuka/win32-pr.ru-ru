---
description: Дополнительные сведения о методе API. Жетстопсервицеинстанце
title: API. Жетстопсервицеинстанце, метод
...
ms.locfileid: "127066106"
---
# <a name="apijetstopserviceinstance-method"></a>API. Жетстопсервицеинстанце, метод

Подготавливает экземпляр к завершению.
