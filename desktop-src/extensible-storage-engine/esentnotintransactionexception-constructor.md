---
description: 'Дополнительные сведения о: конструктор Есентнотинтрансактионексцептион'
title: Конструктор Есентнотинтрансактионексцептион
...
ms.locfileid: "127242779"
---
# <a name="esentnotintransactionexception-constructor"></a>Конструктор Есентнотинтрансактионексцептион

Инициализирует новый экземпляр класса Есентнотинтрансактионексцептион.
