---
description: 'Дополнительные сведения о: конструктор Есентупдатемустверсионексцептион'
title: Конструктор Есентупдатемустверсионексцептион
...
ms.locfileid: "127172424"
---
# <a name="esentupdatemustversionexception-constructor"></a>Конструктор Есентупдатемустверсионексцептион

Инициализирует новый экземпляр класса Есентупдатемустверсионексцептион.
