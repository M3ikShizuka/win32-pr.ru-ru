---
description: 'Дополнительные сведения о: конструктор Есентдискексцептион'
title: Конструктор Есентдискексцептион
...
ms.locfileid: "119839775"
---
# <a name="esentdiskexception-constructor"></a>Конструктор Есентдискексцептион
