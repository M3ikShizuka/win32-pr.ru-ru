---
description: 'Дополнительные сведения о свойстве: JET_SETCOLUMN. Ибдата'
title: Свойство JET_SETCOLUMN. Ибдата
...
ms.locfileid: "127569803"
---
# <a name="jet_setcolumnibdata-property"></a>Свойство JET_SETCOLUMN. Ибдата

Возвращает или задает смещение данных для задания.
