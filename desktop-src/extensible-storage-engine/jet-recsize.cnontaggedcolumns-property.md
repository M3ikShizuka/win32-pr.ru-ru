---
description: 'Дополнительные сведения о свойстве: JET_RECSIZE. Кнонтагжедколумнс'
title: Свойство JET_RECSIZE. Кнонтагжедколумнс (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "126969074"
---
# <a name="jet_recsizecnontaggedcolumns-property"></a>Свойство JET_RECSIZE. Кнонтагжедколумнс

Возвращает общее число фиксированных и переменных столбцов, заданных в этой записи.
