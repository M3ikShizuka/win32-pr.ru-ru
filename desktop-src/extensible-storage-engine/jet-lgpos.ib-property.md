---
description: 'Дополнительные сведения о: JET_LGPOS. геособственность'
title: Свойство JET_LGPOS.
...
ms.locfileid: "126887389"
---
# <a name="jet_lgposib-property"></a>Свойство JET_LGPOS.

Возвращает или задает смещение в байтах, представленное данной позицией журнала. Это смещение находится внутри сектора.
