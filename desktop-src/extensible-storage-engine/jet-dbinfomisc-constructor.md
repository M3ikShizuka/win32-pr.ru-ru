---
description: 'Дополнительные сведения о: конструктор JET_DBINFOMISC'
title: Конструктор JET_DBINFOMISC
...
ms.locfileid: "126969145"
---
# <a name="jet_dbinfomisc-constructor"></a>Конструктор JET_DBINFOMISC
