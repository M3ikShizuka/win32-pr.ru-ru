---
description: 'Дополнительные сведения о свойстве: JET_INDEXCREATE. cbKey'
title: Свойство JET_INDEXCREATE. cbKey
...
ms.locfileid: "127058190"
---
# <a name="jet_indexcreatecbkey-property"></a>Свойство JET_INDEXCREATE. cbKey

Возвращает или задает длину (в символах) Сзкэй, включая два завершающих значения NULL.
