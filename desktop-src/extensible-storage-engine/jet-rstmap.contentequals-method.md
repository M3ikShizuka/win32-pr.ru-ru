---
description: 'Дополнительные сведения о: JET_RSTMAP. Метод Контентекуалс'
title: JET_RSTMAP. Метод Контентекуалс
...
ms.locfileid: "127145422"
---
# <a name="jet_rstmapcontentequals-method"></a>JET_RSTMAP. Метод Контентекуалс
...
#### <a name="parameters"></a>Параметры
  ...
  - иное  
    Тип: [Microsoft.ISAM.ESENT.Interop.JET_RSTMAP](./jet-rstmap-class.md)  
