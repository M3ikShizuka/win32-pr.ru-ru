...
ms.locfileid: "127055829"
---
# <a name="esentnocurrentrecordexception-constructor"></a>Конструктор Есентнокуррентрекордексцептион

Инициализирует новый экземпляр класса Есентнокуррентрекордексцептион.
