...
ms.locfileid: "127270027"
---
# <a name="esentcontainernotemptyexception-constructor"></a>Конструктор Есентконтаинернотемптексцептион

Инициализирует новый экземпляр класса Есентконтаинернотемптексцептион.
