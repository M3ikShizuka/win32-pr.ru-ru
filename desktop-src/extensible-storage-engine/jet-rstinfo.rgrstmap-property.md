---
description: 'Дополнительные сведения о свойстве: JET_RSTINFO. ргрстмап'
title: Свойство JET_RSTINFO. ргрстмап
...
ms.locfileid: "126965569"
---
# <a name="jet_rstinforgrstmap-property"></a>Свойство JET_RSTINFO. ргрстмап

Возвращает или задает массив структур [JET_RSTMAP](./jet-rstmap-class.md) .
