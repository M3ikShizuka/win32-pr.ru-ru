---
description: 'Дополнительные сведения о свойстве: JET_RETRIEVECOLUMN. Ибдата'
title: Свойство JET_RETRIEVECOLUMN. Ибдата
...
ms.locfileid: "126962849"
---
# <a name="jet_retrievecolumnibdata-property"></a>Свойство JET_RETRIEVECOLUMN. Ибдата

Возвращает или задает смещение в буфере, в котором будут храниться данные.
