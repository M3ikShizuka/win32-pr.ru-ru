---
description: 'Дополнительные сведения о свойстве: JET_RETRIEVECOLUMN. Кбактуал'
title: Свойство JET_RETRIEVECOLUMN. Кбактуал
...
ms.locfileid: "126962873"
---
# <a name="jet_retrievecolumncbactual-property"></a>Свойство JET_RETRIEVECOLUMN. Кбактуал

Возвращает размер данных в байтах, извлекаемый операцией извлечения столбца.
