---
description: 'Дополнительные сведения о: Windows7Grbits. Интринсиклвсонли поле'
title: Поле Windows7Grbits. Интринсиклвсонли (Microsoft. ISAM. ESENT. Interop. Windows7)
...
ms.locfileid: "127567658"
---
# <a name="windows7grbitsintrinsiclvsonly-field"></a>Windows7Grbits. Интринсиклвсонли, поле

Разрешается только встроенная функция LV (поэтому использование материализации не требуется, просто потому, что TT имеет столбец LV).
