---
description: 'Дополнительные сведения о свойстве: JET_SNPROG. Кунитдоне'
title: Свойство JET_SNPROG. Кунитдоне
...
ms.locfileid: "127263595"
---
# <a name="jet_snprogcunitdone-property"></a>Свойство JET_SNPROG. Кунитдоне

Возвращает количество единиц работы, которые уже были завершены во время операции длительного выполнения.
