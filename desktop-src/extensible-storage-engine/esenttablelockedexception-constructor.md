...
ms.locfileid: "126887677"
---
# <a name="esenttablelockedexception-constructor"></a>Конструктор Есенттаблелоккедексцептион

Инициализирует новый экземпляр класса Есенттаблелоккедексцептион.
