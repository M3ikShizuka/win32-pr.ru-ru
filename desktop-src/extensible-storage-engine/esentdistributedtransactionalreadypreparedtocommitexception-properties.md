...
ms.locfileid: "127170339"
---
# <a name="esentdistributedtransactionalreadypreparedtocommitexception-properties"></a>Свойства Есентдистрибутедтрансактионалреадипрепаредтокоммитексцептион
