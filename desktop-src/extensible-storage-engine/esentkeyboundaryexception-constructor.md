---
description: 'Дополнительные сведения о: конструктор Есенткэйбаундарексцептион'
title: Конструктор Есенткэйбаундарексцептион
...
ms.locfileid: "126963206"
---
# <a name="esentkeyboundaryexception-constructor"></a>Конструктор Есенткэйбаундарексцептион

Инициализирует новый экземпляр класса Есенткэйбаундарексцептион.
...
[Элементы Есенткэйбаундарексцептион](./esentkeyboundaryexception-members.md)
