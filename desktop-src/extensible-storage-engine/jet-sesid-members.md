---
description: 'Дополнительные сведения о: JET_SESID Members'
title: Элементы JET_SESID
...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: dd3f846c00428eadeb3a02accb29036fe8f6782f11bc80eae85ff6d315ec04e8
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/11/2021
ms.locfileid: "119968094"
---
# <a name="jet_sesid-members"></a>Элементы JET_SESID

Включить защищенные члены  
Включить унаследованные члены  

JET_SESID содержит маркер сеанса, используемый для вызовов JET Апир-.

Тип [JET_SESID](./jet-sesid-structure.md) предоставляет следующие члены.
...
<td><a href="hh556905(v=exchg.10).md">Указатель</a></td>
<td>Возвращает JET_SESID null.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh577899(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_SESID.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh565630(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_SESID неравными.</td>
</tr>
</tbody>
</table>
