---
description: 'Дополнительные сведения о: конструктор Есентиндекскантбуилдексцептион'
title: Конструктор Есентиндекскантбуилдексцептион
...
ms.locfileid: "120065254"
---
# <a name="esentindexcantbuildexception-constructor"></a>Конструктор Есентиндекскантбуилдексцептион

Инициализирует новый экземпляр класса Есентиндекскантбуилдексцептион.
...
[Элементы Есентиндекскантбуилдексцептион](./esentindexcantbuildexception-members.md)
