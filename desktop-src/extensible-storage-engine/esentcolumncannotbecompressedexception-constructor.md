---
description: 'Дополнительные сведения о: конструктор Есентколумнканнотбекомпресседексцептион'
title: Конструктор Есентколумнканнотбекомпресседексцептион
...
Инициализирует новый экземпляр класса Есентколумнканнотбекомпресседексцептион.
...
[Элементы Есентколумнканнотбекомпресседексцептион](./esentcolumncannotbecompressedexception-members.md)
