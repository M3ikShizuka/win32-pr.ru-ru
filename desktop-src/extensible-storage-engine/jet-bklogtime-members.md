---
description: 'Дополнительные сведения о: JET_BKLOGTIME Members'
title: Элементы JET_BKLOGTIME
...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 5d0b18259a6f7667264ea250338ec20120c9cabbed379ec46f38181d7b3b9340
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/11/2021
ms.locfileid: "119360444"
---
# <a name="jet_bklogtime-members"></a>Элементы JET_BKLOGTIME
...
<td><a href="hh596626(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_BKLOGTIME.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh578879(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_BKLOGTIME неравными.</td>
</tr>
</tbody>
</table>
