---
description: 'Дополнительные сведения о: JET_RETINFO. Метод ToString'
title: JET_RETINFO. Метод ToString
...
Возвращает [строку](/dotnet/api/system.string) , представляющую текущий [JET_RETINFO](./jet-retinfo-class.md).
