---
description: Дополнительные сведения о свойстве Transaction. Исинтрансактион
title: Transaction. Исинтрансактион, свойство
...
ms.locfileid: "127461106"
---
# <a name="transactionisintransaction-property"></a>Transaction. Исинтрансактион, свойство

Возвращает значение, указывающее, находится ли данный объект в данный момент в транзакции.
