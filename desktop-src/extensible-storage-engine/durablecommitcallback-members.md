---
description: 'Дополнительные сведения о: Дураблекоммиткаллбакк Members'
title: Элементы Дураблекоммиткаллбакк (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "120066854"
---
# <a name="durablecommitcallback-members"></a>Элементы Дураблекоммиткаллбакк

Включить защищенные члены  
Включить унаследованные члены  

Заключает обратный вызов, работающий с устойчивыми фиксациями.
...
<td><a href="dn335324(v=exchg.10).md">дураблекоммиткаллбакк</a></td>
<td>Инициализирует новый экземпляр класса <a href="dn335323(v=exchg.10).md">дураблекоммиткаллбакк</a> .</td>
</tr>
</tbody>
</table>
