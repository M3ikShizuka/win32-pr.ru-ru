---
description: 'Дополнительные сведения о: конструктор Есенткуеринотсуппортедексцептион'
title: Конструктор Есенткуеринотсуппортедексцептион
...
ms.locfileid: "126965937"
---
# <a name="esentquerynotsupportedexception-constructor"></a>Конструктор Есенткуеринотсуппортедексцептион

Инициализирует новый экземпляр класса Есенткуеринотсуппортедексцептион.
...
[Элементы Есенткуеринотсуппортедексцептион](./esentquerynotsupportedexception-members.md)
