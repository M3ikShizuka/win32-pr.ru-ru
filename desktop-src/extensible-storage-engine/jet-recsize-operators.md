---
description: 'Дополнительные сведения: операторы JET_RECSIZE'
title: Операторы JET_RECSIZE (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "126965606"
---
# <a name="jet_recsize-operators"></a>Операторы JET_RECSIZE
