---
description: 'Дополнительные сведения о: конструктор Есенттуманиколумнсексцептион'
title: Конструктор Есенттуманиколумнсексцептион
...
ms.locfileid: "127252784"
---
# <a name="esenttoomanycolumnsexception-constructor"></a>Конструктор Есенттуманиколумнсексцептион

Инициализирует новый экземпляр класса Есенттуманиколумнсексцептион.
