---
description: 'Дополнительные сведения: методы Инстанцепараметерс'
title: Методы Инстанцепараметерс
...
ms.locfileid: "127458182"
---
# <a name="instanceparameters-methods"></a>Методы Инстанцепараметерс
