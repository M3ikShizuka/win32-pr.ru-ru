---
description: 'Дополнительные сведения о: JET_COMMIT_ID классе'
title: Класс JET_COMMIT_ID (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "127575070"
---
# <a name="jet_commit_id-class"></a>Класс JET_COMMIT_ID

Информационные контекстные данные, порожденные из JET_PFNEMITLOGDATA.
