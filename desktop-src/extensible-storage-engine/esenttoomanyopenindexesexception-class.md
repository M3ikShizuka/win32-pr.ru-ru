...
ms.locfileid: "127345219"
---
# <a name="esenttoomanyopenindexesexception-class"></a>Класс Есенттуманйопениндексесексцептион
        ...
        [Microsoft. ISAM. ESENT. Interop. Есентоператионексцептион](./esentoperationexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентресаурцеексцептион](./esentresourceexception-class.md)  
            [Microsoft. ISAM. ESENT. Interop. Есентмеморексцептион](./esentmemoryexception-class.md)  
              Microsoft. ISAM. ESENT. Interop. Есенттуманйопениндексесексцептион  
...
[Элементы Есенттуманйопениндексесексцептион](./esenttoomanyopenindexesexception-members.md)
