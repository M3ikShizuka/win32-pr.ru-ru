---
description: 'Дополнительные сведения: JET_INSTANCE методы'
title: Методы JET_INSTANCE
...
ms.locfileid: "126965709"
---
# <a name="jet_instance-methods"></a>Методы JET_INSTANCE
