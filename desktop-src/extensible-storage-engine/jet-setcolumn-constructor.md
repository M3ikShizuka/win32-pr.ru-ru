---
description: 'Дополнительные сведения о: конструктор JET_SETCOLUMN'
title: Конструктор JET_SETCOLUMN
...
ms.locfileid: "127174632"
---
# <a name="jet_setcolumn-constructor"></a>Конструктор JET_SETCOLUMN
