---
description: 'Дополнительные сведения о свойстве: JET_RSTINFO. Лгпосстоп'
title: Свойство JET_RSTINFO. Лгпосстоп
...
ms.locfileid: "126965585"
---
# <a name="jet_rstinfolgposstop-property"></a>Свойство JET_RSTINFO. Лгпосстоп

Возвращает или задает расположение журнала для отмены восстановления.
