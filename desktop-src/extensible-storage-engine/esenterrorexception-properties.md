---
description: 'Дополнительные сведения о: Есентеррорексцептион свойства'
title: Свойства Есентеррорексцептион
...
ms.locfileid: "119891704"
---
# <a name="esenterrorexception-properties"></a>Свойства Есентеррорексцептион
...
<td>Возвращает основную ошибку ESENT для этого исключения.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
