---
description: 'Дополнительные сведения о: JET_INSTANCE Members'
title: Элементы JET_INSTANCE
...
ms.locfileid: "119473974"
---
# <a name="jet_instance-members"></a>Элементы JET_INSTANCE
...
Тип [JET_INSTANCE](./jet-instance-structure.md) предоставляет следующие члены.
...
<td><a href="hh578872(v=exchg.10).md">Указатель</a></td>
<td>Возвращает JET_INSTANCE null.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh564998(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_INSTANCE.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh557678(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_INSTANCE неравными.</td>
</tr>
</tbody>
</table>
