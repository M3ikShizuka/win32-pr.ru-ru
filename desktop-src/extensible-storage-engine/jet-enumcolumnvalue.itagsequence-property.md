---
description: 'Дополнительные сведения о свойстве: JET_ENUMCOLUMNVALUE. Итагсекуенце'
title: Свойство JET_ENUMCOLUMNVALUE. Итагсекуенце
...
ms.locfileid: "126882968"
---
# <a name="jet_enumcolumnvalueitagsequence-property"></a>Свойство JET_ENUMCOLUMNVALUE. Итагсекуенце

Возвращает значение столбца (с использованием одномерного индекса), которое было перечислено.
