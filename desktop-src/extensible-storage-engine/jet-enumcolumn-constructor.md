---
description: 'Дополнительные сведения о: конструктор JET_ENUMCOLUMN'
title: Конструктор JET_ENUMCOLUMN
...
ms.locfileid: "127174635"
---
# <a name="jet_enumcolumn-constructor"></a>Конструктор JET_ENUMCOLUMN
