---
description: 'Дополнительные сведения о: конструктор Есентвритеконфликтексцептион'
title: Конструктор Есентвритеконфликтексцептион
...
ms.locfileid: "126964365"
---
# <a name="esentwriteconflictexception-constructor"></a>Конструктор Есентвритеконфликтексцептион

Инициализирует новый экземпляр класса Есентвритеконфликтексцептион.
