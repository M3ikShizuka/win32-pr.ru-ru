...
ms.locfileid: "127461149"
---
# <a name="esentfeaturenotavailableexception-constructor"></a>Конструктор Есентфеатуренотаваилабликсцептион

Инициализирует новый экземпляр класса Есентфеатуренотаваилабликсцептион.
