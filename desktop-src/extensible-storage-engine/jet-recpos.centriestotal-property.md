---
description: 'Дополнительные сведения о свойстве: JET_RECPOS. Центриестотал'
title: Свойство JET_RECPOS. Центриестотал
...
ms.locfileid: "126882872"
---
# <a name="jet_recposcentriestotal-property"></a>Свойство JET_RECPOS. Центриестотал

Возвращает или задает приблизительное количество записей в индексе.
