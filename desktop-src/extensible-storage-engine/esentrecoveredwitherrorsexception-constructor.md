---
description: 'Дополнительные сведения о: конструктор Есентрековередвисеррорсексцептион'
title: Конструктор Есентрековередвисеррорсексцептион
...
ms.locfileid: "127055821"
---
# <a name="esentrecoveredwitherrorsexception-constructor"></a>Конструктор Есентрековередвисеррорсексцептион

Инициализирует новый экземпляр класса Есентрековередвисеррорсексцептион.
...
[Элементы Есентрековередвисеррорсексцептион](./esentrecoveredwitherrorsexception-members.md)
