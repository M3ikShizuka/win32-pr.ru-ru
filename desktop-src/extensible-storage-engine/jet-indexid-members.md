---
description: 'Дополнительные сведения о: JET_INDEXID Members'
title: Элементы JET_INDEXID
...
ms.locfileid: "127566426"
---
# <a name="jet_indexid-members"></a>Элементы JET_INDEXID
...
<td><a href="hh566531(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_INDEXID.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh577553(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_INDEXID неравными.</td>
</tr>
</tbody>
</table>
