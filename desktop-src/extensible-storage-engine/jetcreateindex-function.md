...
|------------|----------|
| <p>Клиент</p> | <p>требуется Windows Vista, Windows XP или Windows 2000 Professional.</p> | 
| <p>Сервер</p> | <p>требуется Windows server 2008, Windows server 2003 или сервер Windows 2000.</p> | 
| <p>Заголовок</p> | <p>Объявляется в ESENT. h.</p> | 
| <p>Библиотека</p> | <p>Использует ESENT. lib.</p> | 
| <p>DLL</p> | <p>Требуется ESENT.dll.</p> | 
| <p>Юникод</p> | <p>Реализуется как <strong>жеткреатеиндексв</strong> (Юникод) и <strong>жеткреатеиндекса</strong> (ANSI).</p> | 
