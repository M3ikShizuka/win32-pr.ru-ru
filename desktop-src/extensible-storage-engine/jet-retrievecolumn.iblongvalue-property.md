---
description: 'Дополнительные сведения о свойстве: JET_RETRIEVECOLUMN. Иблонгвалуе'
title: Свойство JET_RETRIEVECOLUMN. Иблонгвалуе
...
ms.locfileid: "126962842"
---
# <a name="jet_retrievecolumniblongvalue-property"></a>Свойство JET_RETRIEVECOLUMN. Иблонгвалуе

Возвращает или задает смещение для первого байта, получаемого из столбца типа [лонгбинари](./jet-coltyp-enumeration.md) или [LongText](./jet-coltyp-enumeration.md).
