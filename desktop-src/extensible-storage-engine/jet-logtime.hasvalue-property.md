---
description: 'Дополнительные сведения о: JET_LOGTIME. Свойство HasValue'
title: JET_LOGTIME. Свойство HasValue
...
ms.locfileid: "126969105"
---
# <a name="jet_logtimehasvalue-property"></a>JET_LOGTIME. Свойство HasValue

Возвращает значение, указывающее, имеет ли JET_LOGTIME значение null.
