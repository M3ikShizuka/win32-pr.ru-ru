---
description: 'Дополнительные сведения о: конструктор Есентнотинитиализедексцептион'
title: Конструктор Есентнотинитиализедексцептион
...
ms.locfileid: "127347299"
---
# <a name="esentnotinitializedexception-constructor"></a>Конструктор Есентнотинитиализедексцептион

Инициализирует новый экземпляр класса Есентнотинитиализедексцептион.
