---
description: 'Дополнительные сведения о: конструктор Есентлогсекуенцеендексцептион'
title: Конструктор Есентлогсекуенцеендексцептион
...
ms.locfileid: "127055853"
---
# <a name="esentlogsequenceendexception-constructor"></a>Конструктор Есентлогсекуенцеендексцептион

Инициализирует новый экземпляр класса Есентлогсекуенцеендексцептион.
