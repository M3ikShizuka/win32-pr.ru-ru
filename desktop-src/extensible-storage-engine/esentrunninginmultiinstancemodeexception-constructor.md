...
ms.locfileid: "127567678"
---
# <a name="esentrunninginmultiinstancemodeexception-constructor"></a>Конструктор Есентруннингинмултиинстанцемодиксцептион

Инициализирует новый экземпляр класса Есентруннингинмултиинстанцемодиксцептион.
