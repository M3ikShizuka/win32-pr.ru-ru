---
description: 'Дополнительные сведения о свойстве: JET_ERRINFOBASIC. Еррвалуе'
title: Свойство JET_ERRINFOBASIC. Еррвалуе (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "127567007"
---
# <a name="jet_errinfobasicerrvalue-property"></a>Свойство JET_ERRINFOBASIC. Еррвалуе

Возвращает или задает значение ошибки для запрошенного уровня info.
