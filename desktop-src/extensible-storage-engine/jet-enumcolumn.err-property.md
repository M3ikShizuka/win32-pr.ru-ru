---
description: 'Дополнительные сведения о свойстве: JET_ENUMCOLUMN. ERR'
title: Свойство JET_ENUMCOLUMN. ERR
...
ms.locfileid: "126964322"
---
# <a name="jet_enumcolumnerr-property"></a>Свойство JET_ENUMCOLUMN. ERR

Возвращает код состояния столбца, полученный в результате перечисления.
...
[колумнсинглевалуе](./jet-wrn-enumeration.md)
