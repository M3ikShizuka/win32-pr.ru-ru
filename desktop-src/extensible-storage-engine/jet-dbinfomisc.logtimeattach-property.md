---
description: 'Дополнительные сведения о свойстве: JET_DBINFOMISC. Логтимеаттач'
title: Свойство JET_DBINFOMISC. Логтимеаттач
...
ms.locfileid: "127567670"
---
# <a name="jet_dbinfomisclogtimeattach-property"></a>Свойство JET_DBINFOMISC. Логтимеаттач

Возвращает время, когда была присоединена база данных.
