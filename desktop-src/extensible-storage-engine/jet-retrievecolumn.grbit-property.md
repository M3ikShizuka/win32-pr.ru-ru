---
description: 'Дополнительные сведения о свойстве: JET_RETRIEVECOLUMN. грбит'
title: Свойство JET_RETRIEVECOLUMN. грбит
...
ms.locfileid: "126962846"
---
# <a name="jet_retrievecolumngrbit-property"></a>Свойство JET_RETRIEVECOLUMN. грбит

Возвращает или задает параметры для извлечения столбца.
