---
description: 'Дополнительные сведения: методы Есентнокуррентрекордексцептион'
title: 'Методы EsentNoCurrentRecordException '
...
ms.locfileid: "126963134"
---
# <a name="esentnocurrentrecordexception-methods"></a>Методы EsentNoCurrentRecordException 
