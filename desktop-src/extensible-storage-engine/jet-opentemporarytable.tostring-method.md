---
description: 'Дополнительные сведения о: JET_OPENTEMPORARYTABLE. Метод ToString'
title: JET_OPENTEMPORARYTABLE. Метод ToString (Microsoft. ISAM. ESENT. Interop. Vista)
...
Возвращает [строку](/dotnet/api/system.string) , представляющую текущий [JET_OPENTEMPORARYTABLE](./jet-opentemporarytable-class.md).
...
[Строка](/dotnet/api/system.string) , представляющая текущий [JET_OPENTEMPORARYTABLE](./jet-opentemporarytable-class.md).  
