---
description: 'Дополнительные сведения о свойстве: JET_TABLECREATE. Сзтемплатетабленаме'
title: Свойство JET_TABLECREATE. Сзтемплатетабленаме
...
ms.locfileid: "127172399"
---
# <a name="jet_tablecreatesztemplatetablename-property"></a>Свойство JET_TABLECREATE. Сзтемплатетабленаме

Возвращает или задает имя таблицы, из которой наследуется базовый DDL.
