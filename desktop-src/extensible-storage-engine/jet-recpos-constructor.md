---
description: 'Дополнительные сведения о: конструктор JET_RECPOS'
title: Конструктор JET_RECPOS
...
ms.locfileid: "126962930"
---
# <a name="jet_recpos-constructor"></a>Конструктор JET_RECPOS
