...
ms.locfileid: "127575083"
---
# <a name="esentresourcecheckobjectisnotdisposed-method"></a>Есентресаурце. Чеккобжектиснотдиспосед, метод

Создать исключение, если этот объект был удален.
