---
description: 'Дополнительные сведения о: JET_LOGTIME. Исутк, свойство'
title: JET_LOGTIME. Исутк, свойство
...
ms.locfileid: "126969101"
---
# <a name="jet_logtimeisutc-property"></a>JET_LOGTIME. Исутк, свойство

Возвращает значение, указывающее, находится ли JET_LOGTIME в формате UTC.
