---
description: 'Дополнительные сведения: структура JET_COLUMNID'
title: Структура JET_COLUMNID
...
ms.locfileid: "127469449"
---
# <a name="jet_columnid-structure"></a>Структура JET_COLUMNID
