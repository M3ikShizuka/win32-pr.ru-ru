---
description: 'Дополнительные сведения о: конструктор Есентспаваилексткачеаутофмеморексцептион'
title: Конструктор Есентспаваилексткачеаутофмеморексцептион
...
ms.locfileid: "127347275"
---
# <a name="esentspavailextcacheoutofmemoryexception-constructor"></a>Конструктор Есентспаваилексткачеаутофмеморексцептион

Инициализирует новый экземпляр класса Есентспаваилексткачеаутофмеморексцептион.
...
[Элементы Есентспаваилексткачеаутофмеморексцептион](./esentspavailextcacheoutofmemoryexception-members.md)
