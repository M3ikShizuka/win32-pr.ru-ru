---
description: 'Дополнительные сведения о: конструктор Колумнвалуе'
title: Конструктор Колумнвалуе
...
ms.locfileid: "127462402"
---
# <a name="columnvalue-constructor"></a>Конструктор Колумнвалуе

Инициализирует новый экземпляр класса Колумнвалуе.
