---
description: 'Дополнительные сведения о: конструктор Есентиоексцептион'
title: Конструктор Есентиоексцептион
...
ms.locfileid: "126966137"
---
# <a name="esentioexception-constructor"></a>Конструктор Есентиоексцептион
