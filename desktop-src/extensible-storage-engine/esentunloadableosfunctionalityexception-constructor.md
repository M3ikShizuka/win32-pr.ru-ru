---
description: 'Дополнительные сведения о: конструктор Есентунлоадаблеосфунктионалитексцептион'
title: Конструктор Есентунлоадаблеосфунктионалитексцептион
...
ms.locfileid: "126883109"
---
# <a name="esentunloadableosfunctionalityexception-constructor"></a>Конструктор Есентунлоадаблеосфунктионалитексцептион

Инициализирует новый экземпляр класса Есентунлоадаблеосфунктионалитексцептион.
...
[Элементы Есентунлоадаблеосфунктионалитексцептион](./esentunloadableosfunctionalityexception-members.md)
