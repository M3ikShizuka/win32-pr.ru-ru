...
ms.locfileid: "126888301"
---
# <a name="degrees"></a>градусы

Преобразует указанное значение из радианов в градусы.
...
Результат преобразования параметра *x* из радианов в градусы.
