...
-   [Инструкции. VS \_ 1 \_ 1](dx9-graphics-reference-asm-vs-instructions-vs-1-1.md) содержит список доступных инструкций.
-   [Регистры- \_ VS \_ 1](dx9-graphics-reference-asm-vs-registers-vs-1-1.md) 1 содержит список различных типов регистров, используемых вершиной шейдера ALU.
