...
Параметр *&lt; типа &gt;* и возвращаемое значение этих функций подразумевают тип выражения, Поддерживаемые типы — из следующего списка, которые *также* имеются в целевой модели шейдеров для приложения:
