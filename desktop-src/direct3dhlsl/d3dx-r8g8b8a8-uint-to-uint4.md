...
ms.locfileid: "127345895"
---
# <a name="d3dx_r8g8b8a8_uint_to_uint4-function"></a>D3DX \_ R8G8B8A8 \_ uint \_ в \_ UINT4 Function

Распаковать \_ \_ \_ данные шейдера R8G8B8A8 uint в формате DXGI в XMUINT4.
