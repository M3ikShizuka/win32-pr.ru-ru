...
ms.locfileid: "127363532"
---
# <a name="ibasicdevicemodelname-method"></a>Метод Ибасикдевице:: ModelName

Извлекает имя модели устройства s.
...
Получает указатель на имя модели устройства s.
