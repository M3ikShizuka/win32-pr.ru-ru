...
-   Всегда копировать данные, выводимые в соответствии с объемом памяти. Windows 98 использует обработчик ошибок страницы вфлатд. 386 для реализации виртуального плоского буфера для видеоадаптеров с памятью с банком. Обработчик позволяет этим устройствам отображать линейный буфер кадров для Direct3D. Копирование данных, несогласованных для экрана, может привести к приостановке системы в случае, если копирование охватывает банки памяти.
