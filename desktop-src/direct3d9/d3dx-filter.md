...
Указание D3DX \_ по умолчанию для этого параметра обычно эквивалентно указанию D3DX \_ фильтра \_ D3DX- \| \_ \_ дизеринга Filter. Однако D3DX \_ по умолчанию может иметь разные значения в зависимости от того, какой метод использует фильтр. Например:
