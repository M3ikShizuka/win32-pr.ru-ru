...
| Sum          | Недоступно           | Недоступно           | Суммирование каждого компонента отраженного света.                                                                       |
| Нет            | Недоступно           | D3DVECTOR     | Нормальная вершина.                                                                                                      |
| H            | Недоступно           | D3DVECTOR     | Вектор полупути. См. раздел по вектору полупути.                                                             |
| <sup>P</sup> | 0,0           | FLOAT         | Сила отраженного света Диапазон от 0 до +бесконечность                                                                  |
| Lₛ           | (0,0,0,0)     | D3DCOLORVALUE | Цвет отраженного света.                                                                                               |
| Atten        | Недоступно           | FLOAT         | Значение ослабления света. См. раздел " [ослабление и прожектор" (Direct3D 9)](attenuation-and-spotlight-factor.md). |
...
| Параметр       | Значение по умолчанию | Тип      | Описание                                                  |
|-----------------|---------------|-----------|--------------------------------------------------------------|
| Cₚ              | Недоступно           | D3DVECTOR | Позиция камеры.                                             |
| Vₚ              | Недоступно           | D3DVECTOR | Положение вершины.                                             |
| L<sub>dir</sub> | Недоступно           | D3DVECTOR | Вектор направления из положения вершины к позиции источника освещения. |
