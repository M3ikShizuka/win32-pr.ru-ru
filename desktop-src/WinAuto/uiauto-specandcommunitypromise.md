...
© Корпорация Майкрософт (Microsoft Corporation). Все права защищены. разрешение на копирование, отображение и распространение этого документа доступно в [модели автоматизации пользовательского интерфейса Community обещание](uiauto-specandcommunitypromise.md).
