...
| **ptd**<br/>      | структура [**двтаржетдевице**](/windows/win32/api/objidl/ns-objidl-dvtargetdevice) , которая содержит достаточно информации о Windows целевом устройстве, таком как экран или принтер, чтобы можно было создать обработчик контекста устройства (hDC) с помощью функции [**креатедк**](/windows/desktop/api/wingdi/nf-wingdi-createdca) . <br/> |
