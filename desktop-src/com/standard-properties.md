...
| Шрифт<br/>                                                                                | **Интерфейс \* IDispatch* _<br/>      | Шрифт, используемый в элементе управления, который является указателем _ *IDispatch** на объект стандартного шрифта. Дополнительные сведения см. в разделе [стандартный объект Font](standard-font-object.md) .<br/>                                                         |
