---
description: Windows Сервер 2008 R2 добавляет поддержку распознавания рукописного ввода на стороне сервера для Windows. в этом разделе описывается распознавание рукописного ввода в Windows Server 2008 R2.
ms.assetid: ec22391d-a6e8-49b0-8650-943a661cbcd3
title: распознавание рукописного ввода в Windows Server 2008 R2
ms.topic: article
ms.date: 06/02/2020
...
ms.locfileid: "120008745"
---
# <a name="handwriting-recognition-in-windows-server-2008-r2"></a>распознавание рукописного ввода в Windows Server 2008 R2
...
Щелкните **Далее**. Откроется диалоговое окно обзора. еще раз нажмите кнопку **Далее** . Теперь отобразится страница с предложением параметров для ролей веб-сервера (IIS). Щелкните **Далее**. На следующей странице кнопка " **установить** " станет активной. Нажмите кнопку **установить** , после чего будет установлена поддержка веб-сервера (IIS) и сервера приложений.
...
- установите и обновите Visual Studio 2008, чтобы добавить поддержку для Silverlight.
...
### <a name="install-and-update-visual-studio-2008-to-add-support-for-silverlight"></a>установите и обновите Visual Studio 2008, чтобы добавить поддержку для Silverlight.
...
### <a name="create-a-new-silverlight-web-project-in-visual-studio-2008"></a>создание нового веб-Project Silverlight в Visual Studio 2008
...
После нажатия кнопки **ОК** появится диалоговое окно, предлагающее добавить в проект приложение Silverlight. выберите **добавить новый ASP.NET веб-проект в решение для размещения Silverlight** и нажмите кнопку **ок**. На следующем рисунке показано, как настроить пример проекта перед нажатием кнопки **ОК**.
...
### <a name="add-the-necessary-service-references-to-your-project"></a>Добавьте необходимые ссылки на службы в Project
...
### <a name="add-the-service-reference-to-your-client-project"></a>Добавление ссылки на службу в клиент Project
...
### <a name="add-the-inkcollector-class-to-the-inkrecognition-project"></a>Добавьте класс InkCollector в Инкрекогнитион Project
