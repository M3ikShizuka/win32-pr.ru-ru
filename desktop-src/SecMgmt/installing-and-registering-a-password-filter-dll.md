---
description: Windows DLL фильтра паролей, Passfilt.dll, выполняется в контексте безопасности локальной системной учетной записи и помогает фильтровать пароли домена или локальной учетной записи.
...
**установка и регистрация библиотеки Windows DLL для фильтрации паролей**
...
4.  чтобы применить фильтр по умолчанию Windows и настраиваемый фильтр паролей, убедитесь, что включен параметр политики **пароли должны соответствовать требованиям сложности** . В противном случае отключите параметр политики **пароли должны соответствовать требованиям сложности** .
