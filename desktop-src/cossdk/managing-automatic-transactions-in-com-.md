...
ms.locfileid: "127347607"
---
# <a name="managing-automatic-transactions-in-com"></a>Управление автоматическими транзакциями в COM+

в модели программирования COM+ можно разрабатывать компоненты, чтобы сделать их лучше, обеспечивая бизнес-логику или установление подключения к базе данных, и полагаться на платформу обработки транзакций Microsoft Windows для автоматизации транзакций.
