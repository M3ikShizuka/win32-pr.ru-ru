...
ms.locfileid: "127261392"
---
# <a name="idxtjpegloaddefsettings-method"></a>Метод Идкстжпег:: Лоаддефсеттингс
...
`LoadDefSettings`Метод восстанавливает параметры по умолчанию для перехода на очистку.
