...
Задает уровень нормализации диалогового окна в децибел (dB) в потоке цифрового звука Dolby. Это свойство применяется к кодировщикам цифрового аудио Dolby.
...
**КОДЕКАПИ \_ авенкдддиалогнормализатион**
