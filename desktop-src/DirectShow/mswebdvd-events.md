...
| [**Выход**](resume.md)                                               | Отправляется, если команда **возобновления** включена или отключена.                        |
...
| [**Остановить**](stop.md)                                                   | Отправляется, если команда **остановлена** включена или отключена.                          |
