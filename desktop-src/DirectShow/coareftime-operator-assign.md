...
ms.locfileid: "127053505"
---
# <a name="coareftimeoperator-method-ctlutilh"></a>Коарефтиме. operator =-метод (Ктлутил. h)
...
Ссылка на значение **Double** , указывающее новое время ссылки в секундах.
