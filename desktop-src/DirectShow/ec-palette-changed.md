---
description: Изменилась палитра видео.
...
Модули подготовки видео отправляют это событие, если обнаруживают изменение палитры в потоке.
