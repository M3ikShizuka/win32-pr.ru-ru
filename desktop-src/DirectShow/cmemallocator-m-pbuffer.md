...
ms.locfileid: "127362489"
---
# <a name="cmemallocatorm_pbuffer-member"></a>Элемент Кмемаллокатор:: m \_ pBuffer

Указатель на блок памяти, содержащий буферы.
...
Буферы выборки вычисляются как смещения от этого указателя.
