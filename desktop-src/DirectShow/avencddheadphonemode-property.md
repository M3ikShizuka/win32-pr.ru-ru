...
ms.locfileid: "127161940"
---
# <a name="avencddheadphonemode-property"></a>Авенкддхеадфонемоде, свойство

Указывает режим наушников для потока цифрового звука Dolby. Это свойство применяется к кодировщикам цифрового аудио Dolby.
...
**КОДЕКАПИ \_ авенкддхеадфонемоде**
