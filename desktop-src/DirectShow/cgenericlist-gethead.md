---
description: Метод onhead извлекает элемент в заголовке списка.
ms.assetid: 1cbaa790-e26a-4d81-b96b-3a07b22dff1e
title: Метод Кженериклист. onhead (Вкслист. h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127054741"
---
# <a name="cgenericlistgethead-method"></a>Метод Кженериклист. onhead

`GetHead`Метод извлекает элемент в заголовке списка.
