---
description: Метод NOCOUNT извлекает количество элементов в списке.
ms.assetid: a74fcddd-109f-4abf-abe0-e00f6e56ea0f
title: Метод Кженериклист. NOCOUNT (Вкслист. h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127055595"
---
# <a name="cgenericlistgetcount-method"></a>Кженериклист. NOCOUNT, метод

`GetCount`Метод извлекает количество элементов в списке.
