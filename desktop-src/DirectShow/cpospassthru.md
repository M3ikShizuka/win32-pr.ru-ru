...
| [**GetCapabilities**](cpospassthru-getcapabilities.md)           | Извлекает все возможности поиска в потоке.                                               |
