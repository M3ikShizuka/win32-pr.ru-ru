---
title: уведомление индекса изменений (устаревшие функции Windows среды)
description: при использовании Microsoft Windows Desktop Search (WDS) 2,6 обработчики протоколов для данного хранилища данных могут сообщить индексатору WDS об изменении данных в их хранилище.
...
ms.locfileid: "119601764"
---
# <a name="notifying-the-index-of-changes-legacy-windows-environment-features"></a>уведомление индекса изменений (устаревшие функции Windows среды)
...
|---------------|--------------------------------|----------------------------------------------------------------------------|
| Изменение        | \_тип поиска \_ \_ изменений       | Тип изменения, для которого выполняется оповещение.                                 |
