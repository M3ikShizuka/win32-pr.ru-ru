...
| **Обдумывание**               | Нет                     | Нет                | **Нет**        | Нет                                         | Поиск с крыло по грани ( \* анимация цикла)       |
...
| **Запись**                | Да, с использованием ветвей выхода | Нет                | **Да**       | Нет                                         | Принимает карандаш и планшеты, записи ( \* циклическая анимация) |
