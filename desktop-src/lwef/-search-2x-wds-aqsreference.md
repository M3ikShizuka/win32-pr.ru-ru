...
| Текстовые документы                  | текст             | Тип: текст                      |
...
| >            | Дата: >11/13/21<br/> Размер: >500<br/>  | Находит элементы с датой после мм/дд/гг. <br/> Находит элементы размером более 500 байт.<br/> |
| <            | Дата: <11/13/21 <br/> Размер: <500<br/> | Находит элементы с датой до MM/ДД/гг. <br/> Находит элементы размером менее 500 байт.<br/>   |
| ..              | Дата: 11/13/21.. 11/15/21<br/>                    | Находит элементы с датой, начинающейся с мм/дд/гг и заканчивая на мм/дд/гг.<br/>                               |
...
| Deleted        | удален или isDeleted     | IsDeleted: true                 |
...
| Домашняя страница для бизнеса    | бусинесшомепаже    | бусинесшомепаже:ВВВ. Office. com |
...
| Длительность       | длительность                      | Длительность: > 50                |
...
| Длительность | длительность           | Длительность: 3               |
