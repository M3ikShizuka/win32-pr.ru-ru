...
функция window реализована для получения сообщений в юникоде или Windows формате кодовой страницы. Оконная функция может передавать сообщения или вызывать функции любого из этих типов.
