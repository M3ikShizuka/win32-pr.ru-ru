...
С заполненными фигурами используются следующие функции.



| Функция                           | Описание                                                     |
|------------------------------------|-----------------------------------------------------------------|
| [**Хордовая диаграмма**](/windows/desktop/api/Wingdi/nf-wingdi-chord)             | Рисует область, ограниченную эллипсом и сегментом линии.         |
| [**Эллипс**](/windows/desktop/api/Wingdi/nf-wingdi-ellipse)         | Рисование эллипса.                                               |
