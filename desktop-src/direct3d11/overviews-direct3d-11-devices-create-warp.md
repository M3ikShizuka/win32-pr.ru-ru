...
2.  Запросите уровень функций, реализующий функции, которые понадобятся вашему приложению. устройство деформации можно успешно создать для уровней компонентов **D3D \_ \_ уровня \_ 9 \_ 1** с помощью **d3d \_ \_ уровня \_ 10 \_ 1** и начиная с Windows 8 для всех уровней компонентов.
