...
ms.locfileid: "127580662"
---
# <a name="id3dx11threadpumpwaitforallitems-method"></a>Метод ID3DX11ThreadPump:: Ваитфораллитемс
...
Ожидает завершения всех рабочих элементов в конвейере потока.
