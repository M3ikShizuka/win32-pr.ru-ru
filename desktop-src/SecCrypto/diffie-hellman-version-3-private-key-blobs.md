...
| P             | Значение P находится непосредственно после структуры [**дхпривкэй \_ VER3**](/windows/win32/api/wincrypt/ns-wincrypt-dhprivkey_ver3) и всегда должно быть длиной в байтах поля **дхпривкэй \_ VER3** **битленп** (разрядная длина P), деленная на 8 (формат с [*прямым порядком байтов*](../secgloss/l-gly.md) ).                                                                                                                                                                                                                            |
