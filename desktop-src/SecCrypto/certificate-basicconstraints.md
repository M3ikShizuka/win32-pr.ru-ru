...
Метод **басикконстраинтс** возвращает объект [**басикконстраинтс**](basicconstraints.md) , представляющий базовое расширение ограничений сертификата.
...
Объект [**басикконстраинтс**](basicconstraints.md) , представляющий расширение базовых ограничений сертификата.
