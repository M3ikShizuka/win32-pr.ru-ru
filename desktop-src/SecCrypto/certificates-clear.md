---
description: Удаляет все объекты сертификата из коллекции.
ms.assetid: 7349a9dd-d17b-4f79-b31d-0d79ff7641d1
title: 'Метод ICertificates2:: Clear'
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Метод **clear** удаляет все объекты [**сертификата**](certificate.md) из коллекции. Этот метод появился в CAPICOM 2,0.
