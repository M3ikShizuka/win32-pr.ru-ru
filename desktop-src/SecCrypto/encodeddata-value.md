---
description: Извлекает закодированные данные.
ms.assetid: 8e07ac14-6859-410f-ab30-84b8d60a94ad
title: Енкодеддата. Value, свойство
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127469915"
---
# <a name="encodeddatavalue-property"></a>Енкодеддата. Value, свойство
...
Свойство **value** извлекает закодированные данные. Это свойство по умолчанию.
...
Строка, содержащая закодированные данные.
