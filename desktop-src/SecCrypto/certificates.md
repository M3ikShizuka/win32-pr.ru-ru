...
| [**Найдено**](certificates-find.md)     | Возвращает объект **Certificates** , который содержит все сертификаты, соответствующие указанным условиям поиска.<br/> (Наследуется от **CertificatesICertificates2**) |
