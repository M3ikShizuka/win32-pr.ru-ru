...
<tr class="odd">
<td>аттркс<br/></td>
<td>Необязательный параметр. Атрибут или оператор о файле или содержимом. Может существовать любое количество атрибутов, включая None.<br/></td>
</tr>
<tr class="even">
<td>тип<br/></td>
