...
> [!Note]  
> обработка транспортных сеансов, описанная здесь, относится к Windows Vista и Windows Server 2008.
