...
| [\_ \_ \_ URL-адрес источника мультимедиа WPD](object-properties.md)                                                                      | Необязательный параметр.                                                                      |
| [\_ \_ \_ URL-адрес назначения мультимедиа WPD](object-properties.md)                                                                 | Необязательный параметр.                                                                      |
| [\_Описание носителя \_ WPD](object-properties.md)                                                                      | Необязательный параметр.                                                                      |
| [\_Жанр носителя \_ WPD](object-properties.md)                                                                            | Необязательный параметр.                                                                      |
| [\_Закладка \_ байта носителя WPD \_](object-properties.md)                                                                   | Необязательный параметр.                                                                      |
| [\_GUID носителя \_ WPD](object-properties.md)                                                                             | Необязательный параметр.                                                                      |
