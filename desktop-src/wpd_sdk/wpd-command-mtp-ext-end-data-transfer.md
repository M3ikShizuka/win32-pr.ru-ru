...
|------------------------------------------------|------------|------------------------------------------------------------------------------|
| **\_свойство WPD \_ для \_ \_ контекста перемещения \_ MTP** | VT \_ LPWSTR | Обязательный элемент. Определяет контекст, возвращаемый предыдущим вызовом метода. |
