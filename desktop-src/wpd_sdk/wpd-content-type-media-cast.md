...
| [Возрастная \_ \_ Категория устройства WPD \_](media-properties.md)                                        | Необязательный параметр.                                                             |
| [\_ \_ мета жанр мультимедиа \_ WPD](media-properties.md)                                                  | Необязательный параметр.                                                             |
| [\_подзаголовок носителя WPD \_ \_](media-properties.md)                                                    | Необязательный параметр.                                                             |
...
| [\_ \_ время \_ \_ жизни носителя (WPD)](media-properties.md)                                             | Необязательный параметр.                                                             |
| [Описание подпрограммы \_ типа WPD Media \_ \_](object-properties.md)                                                                 | Необязательный параметр.                                                             |
...
|-------------------------------------------------------------|----------------------|-----------------------------------------------------------------------------------------------------------------------------|
| [**\_ресурс \_ по умолчанию для WPD**](wpd-resource-default.md)      | Необязательный параметр.            | Содержит данные файла медиакаст. Например, если этот медиакаст представляет RSS-канал, это может быть документ RSS. |
| [**\_эскиз ресурса \_ WPD**](wpd-resource-thumbnail.md)  | Необязательный параметр.            | Содержит эскиз, представляющий этот медиакаст.                                                                         |
...
|---------------------|--------------------------|---------------------------------------------------------------------------------|
| категория            | Необязательный параметр.                | [\_Жанр носителя \_ WPD](media-properties.md)                       |
...
| description         | Обязательный элемент.                | [\_Описание носителя \_ WPD](media-properties.md)           |
...
| link                | Обязательный элемент.                | [\_ \_ \_ URL-адрес назначения мультимедиа WPD](media-properties.md)  |
| managingEditor      | Необязательный параметр.                | [\_Редактор управления носителями WPD \_ \_](media-properties.md)  |
| pubDate             | Необязательный параметр.                | [\_ \_ Дата выпуска носителя \_ WPD](media-properties.md)        |
...
| title               | Обязательный элемент.                | [\_имя объекта \_ WPD](object-properties.md)                      |
| ttl                 | Необязательный элемент.                | [\_ \_ время \_ \_ жизни носителя (WPD)](media-properties.md)       |
| webMaster           | Необязательный параметр.                | [\_Мастер мультимедиа \_ WPD](media-properties.md)               |
...
| title             | Необязательный параметр.                | [\_имя объекта \_ WPD](object-properties.md)                     |
...
|------------------|---------------|--------------------------|--------------------------------------------------------------------------------|
| автор           |               | Необязательный параметр.                | [\_исполнитель мультимедиа \_ WPD](media-properties.md)                    |
| категория         |               | Необязательный элемент.                | [\_Жанр носителя \_ WPD](media-properties.md)                      |
|                  | домен        | Неприменимо.          | Неприменимо.                                                                |
| description      |               | Необязательный параметр.                | [\_Описание носителя \_ WPD](media-properties.md)          |
| корпуса        |               | Необязательный параметр.                |                                                                                |
|                  | url           | Обязательный элемент.                | [\_ \_ \_ URL-адрес источника мультимедиа WPD](media-properties.md)           |
|                  | length        | Обязательный элемент.                | [\_размер объекта \_ WPD](object-properties.md)                     |
|                  | type          | Обязательный элемент.                | (Тип MIME должен быть сопоставлен с типом содержимого свойства.)                 |
| guid             |               | Необязательный параметр.                | [\_GUID носителя \_ WPD](media-properties.md)                        |
|                  | подпостоянная   | Неприменимо.          | Неприменимо.                                                                |
| link             |               | Необязательный параметр.                | [\_ \_ \_ URL-адрес назначения мультимедиа WPD](media-properties.md) |
| pubDate          |               | Необязательный параметр.                | [\_ \_ Дата выпуска носителя \_ WPD](media-properties.md)       |
