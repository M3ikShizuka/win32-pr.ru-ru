...
| [\_ \_ локальный язык объектов \_ WPD](object-properties.md)                                                                                        | Необязательный параметр.                                                             |
| [\_ \_ \_ \_ идентификаторы сети узла сетевых ассоциаций WPD \_](network-association-properties.md) | Обязательный элемент.                                                             |
| [\_X509V3SEQUENCE сетевая \_ Ассоциация WPD \_](network-association-properties.md)                       | Необязательный параметр.                                                             |
