...
| [\_поставщик SMS для WPD \_](sms-properties.md)                                                             | Обязательный элемент.                                                                                                                                              |
| [\_время ожидания SMS-сервера (WPD) \_](sms-properties.md)                                                               | Обязательный элемент.                                                                                                                                              |
| [\_ \_ Максимальное количество полезных данных по SMS для сервера WPD \_](sms-properties.md)                                                      | Обязательный элемент.                                                                                                                                              |
| [\_кодирование SMS \_ WPD](sms-properties.md)                                                             | Обязательный элемент.                                                                                                                                              |
