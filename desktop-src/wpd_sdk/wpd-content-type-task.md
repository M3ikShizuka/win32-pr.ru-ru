...
| [\_субъект общей \_ информации о \_ WPD](object-properties.md)                                                            | Обязательный элемент.                                                                      |
...
| [\_Общие \_ сведения о \_ WPD](object-properties.md)                                                              | Необязательный параметр.                                                                      |
| [\_состояние задачи \_ WPD](task-properties.md)                                                              | Необязательный параметр.                                                                      |
| [\_ \_ процент выполнения задачи \_ WPD](task-properties.md)                                         | Необязательный параметр.                                                                      |
| [\_ \_ Дата напоминания о ЗАДАЧе WPD \_](task-properties.md)                                               | Необязательный параметр.                                                                      |
| [\_владелец задачи \_ WPD](task-properties.md)                                                                | Необязательный параметр.                                                                      |
