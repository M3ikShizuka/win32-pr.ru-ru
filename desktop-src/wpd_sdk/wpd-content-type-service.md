...
| [\_Категория функционального \_ объекта WPD \_](object-properties.md) | Обязательный элемент. Представляет тип службы устройства.                             |
| [\_версия службы \_ WPD](object-properties.md)           | Обязательный элемент.                                                                      |
