...
если файл журнала содержит SQL данные, формат имени файла журнала **SQL:**_источник_ данных *_!_* _LogFilename_. В этом случае значение параметра *лпдвлогтипе* имеет \_ тип журнала PDH \_ \_ SQL.
...
| <span id="PDH_LOG_TYPE_SQL"></span><span id="pdh_log_type_sql"></span><dl> <dt>**\_ \_ SQL типа журнала \_ PDH**</dt> </dl>                   | Данные в файле журнала находятся в SQL.<br/>                                                                          |
