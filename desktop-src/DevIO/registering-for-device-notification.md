...
Если вы хотите собрать и запустить этот пример исходного кода как приложение, начните с создания нового проекта в Microsoft Visual Studio. создайте новый проект на основе шаблона проекта **приложения Windows классическое приложение** . Назовите проект *регистердевиценотификатион*.
