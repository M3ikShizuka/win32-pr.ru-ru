...
| [**Reset**](systemmonitor-reset.md)                         | Удаляет все объекты [**каунтеритем**](counteritem.md) из объекта коллекции **Counters** .<br/>                                                               |
...
| [**Font**](systemmonitor-font.md)<br/>                                           | Возвращает или задает шрифт, используемый в элементе управления.<br/>                                                                                                                                                                              |
