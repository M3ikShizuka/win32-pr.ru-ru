---
description: Указывает число пикселей на единицу разрешения в ширине изображения.
ms.assetid: 6d5ac7df-94a5-404f-a692-c472faabef1f
title: System. Image. Хоризонталресолутион
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127363476"
---
# <a name="systemimagehorizontalresolution"></a>System. Image. Хоризонталресолутион

Указывает число пикселей на единицу разрешения в ширине изображения.
