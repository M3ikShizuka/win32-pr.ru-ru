---
description: Указывает, следует ли запустить этап устройства.
ms.assetid: D75A6D42-D4BB-4168-AD91-E2B8BE847128
title: System. Devices. Лаунчдевицестажефромексплорер
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127257212"
---
# <a name="systemdeviceslaunchdevicestagefromexplorer"></a>System. Devices. Лаунчдевицестажефромексплорер

Указывает, следует ли запустить этап устройства.
