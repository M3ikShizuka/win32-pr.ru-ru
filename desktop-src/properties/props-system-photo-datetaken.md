---
description: Дата съемки фотографии, считанная с камеры в теге файла обмена изображениями (EXIF) файла.
ms.assetid: 197fb739-7fe6-47e8-908f-54e75cb47ec4
title: System. photo. Датетакен
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127460666"
---
# <a name="systemphotodatetaken"></a>System. photo. Датетакен

Дата съемки фотографии, считанная с камеры в теге файла обмена изображениями (EXIF) файла.
