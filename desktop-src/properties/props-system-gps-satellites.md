---
description: Указывает вспомогательные спутники GPS, используемые для измерений.
...
ms.locfileid: "127460736"
---
# <a name="systemgpssatellites"></a>System. GPS. спутники

Указывает вспомогательные спутники GPS, используемые для измерений.
