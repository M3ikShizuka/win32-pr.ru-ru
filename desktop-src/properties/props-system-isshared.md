...
ms.locfileid: "119598494"
---
# <a name="systemisshared"></a>System. Совместное использование

Указывает, является ли элемент общим. При этом проверяются только неунаследованные списки ACL.
