---
description: Определяет, помечено ли сообщение как элемент задачи.
ms.assetid: 0cd86838-34ce-4e49-b4bb-f486a55ab8f6
title: System. Message. Тодофлагс
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127460709"
---
# <a name="systemmessagetodoflags"></a>System. Message. Тодофлагс

Определяет, помечено ли сообщение как элемент задачи.
