---
description: Имя Организации, система оценок которой используется для System. Паренталратинг.
...
Имя Организации, система оценок которой используется для [System. паренталратинг](./props-system-parentalrating.md).
