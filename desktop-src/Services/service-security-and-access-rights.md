...
**Windows Server 2003 и Windows XP:** В отличие от большинства других защищаемых объектов, дескриптор безопасности для SCM не может быть изменен. это поведение изменилось на Windows Server 2003 с пакетом обновления 1 (SP1).
