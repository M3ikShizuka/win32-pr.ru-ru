...
Сертификаты доверенных центров сертификации.
...
|-------------------|-------------------------------------------------------|
| CN                | CA-Certificate                                        |
| LDAP-отображаемое имя | Сохранить                                         |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**Центр сертификации**](c-certificationauthority.md)<br/> [**PKI — регистрация — служба**](c-pkienrollmentservice.md)<br/> [**SAM-домен**](c-samdomain.md)<br/> |
