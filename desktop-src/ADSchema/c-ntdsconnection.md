...
| [**Включено — подключение**](a-enabledconnection.md)                         | Верно      | **NTDS — подключение**             |
...
| [**From-Server**](a-fromserver.md)                                       | Верно      | **NTDS — подключение**             |
...
| [**Создано — подключение**](a-generatedconnection.md)                     | Нет     | **NTDS — подключение**             |
...
| [**MS-DS-replicate-NC-причина**](a-ms-ds-replicatesncreason.md)          | Нет     | **NTDS — подключение**             |
...
| [**Параметры**](a-options.md)                                              | Верно      | **NTDS — подключение**             |
...
| [**Расписание**](a-schedule.md)                                            | Нет     | **NTDS — подключение**             |
...
| [**Тип транспорта**](a-transporttype.md)                                 | Нет     | **NTDS — подключение**             |
