...
ms.locfileid: "120066540"
---
# <a name="msmq-migrated-attribute"></a>Атрибут MSMQ-Migrated

Атрибут, **перенесенный** с помощью MSMQ, содержит сведения о смешанном режиме MSMQ.
...
|-------------------|--------------------------------------|
| CN                | MSMQ-Migrated                        |
| LDAP-отображаемое имя | мсмкмигратед                         |
| Размер              | \-                                   |
