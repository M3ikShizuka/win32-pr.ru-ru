...
keywords:
- active directory — схема AD для класса Параметры пользовательского интерфейса
...
ms.locfileid: "119801794"
---
# <a name="ds-ui-settings-class"></a>класс DS-UI-Параметры
...
| [**DS-UI-Admin — максимум**](a-dsuiadminmaximum.md)                         | Нет     | **DS-UI-Параметры**              |
| [**DS-UI-Admin — уведомление**](a-dsuiadminnotification.md)               | Нет     | **DS-UI-Параметры**              |
| [**DS-UI-Shell-максимум**](a-dsuishellmaximum.md)                         | Нет     | **DS-UI-Параметры**              |
...
| [**MS-DS-целостность-дочерняя — количество**](a-ms-ds-consistencychildcount.md)                    | Нет     | [**Вверх**](c-top.md)<br/> |
| [**MS-DS-Consistencу-Guid**](a-ms-ds-consistencyguid.md)                                 | Нет     | [**Вверх**](c-top.md)<br/> |
| [**MS-DS-Filter-Containers**](a-msds-filtercontainers.md)                                | Нет     | **DS-UI-Параметры**              |
...
| [**MS-DS-non-Security-Group-classes — классы**](a-msds-non-security-group-extra-classes.md) | Нет     | **DS-UI-Параметры**              |
...
| [**MS-DS-Security-Group-дополнительные классы**](a-msds-security-group-extra-classes.md)         | Нет     | **DS-UI-Параметры**              |
