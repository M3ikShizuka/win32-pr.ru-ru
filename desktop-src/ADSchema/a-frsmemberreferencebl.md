...
ms.locfileid: "119925594"
---
# <a name="frs-member-reference-bl-attribute"></a>Атрибут FRS-Member-Reference-BL

Ссылка на объекты подписчика для этого элемента.
...
| LDAP-отображаемое имя | фрсмемберреференцебл                    |
| Размер              | \-                                      |
