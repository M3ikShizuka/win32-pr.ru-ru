...
ms.locfileid: "119803904"
---
# <a name="ms-ds-operations-for-az-role-bl-attribute"></a>Атрибут ms-DS-Operations-for-AZ-Role-BL

Обратная ссылка с Az-Operation на Az-Role объекты, которые связываются с ним.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | MS-DS-Operations-для-AZ-Role-BL         |
| LDAP-отображаемое имя | msDS-Оператионсфоразролебл              |
| Размер              | \-                                      |
