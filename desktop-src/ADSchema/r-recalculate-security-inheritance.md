...
Расширенное право, необходимое для принудительного пересчета наследования ACL в контексте именования.



| Ввод | Значение |
|--------------|--------------------------------------|
| CN           | Перерасчет — безопасность — наследование     |
| Display-Name | Пересчитать наследование безопасности     |
...
| Локализация — идентификатор экрана | 52                                       |
