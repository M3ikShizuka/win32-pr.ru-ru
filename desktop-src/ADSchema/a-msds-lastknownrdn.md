...
ms.locfileid: "118685023"
---
# <a name="ms-ds-last-known-rdn-attribute"></a>Атрибут ms-DS-Last-OutAttribute-RDN

Содержит исходный RDN удаленного объекта.
...
| LDAP-отображаемое имя | msDS-Ласткновнрдн                           |
| Размер              | \-                                          |
