...
ms.locfileid: "119644544"
---
# <a name="user-smime-certificate-attribute"></a>Атрибут пользователя SMIME-Certificate

Объект распространения сертификата или отмеченные сертификаты.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | Пользователь-SMIME-Certificate                                |
| LDAP-отображаемое имя | userSMIMECertificate                                  |
| Размер              | \-                                                    |
