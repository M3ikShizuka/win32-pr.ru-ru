...
ms.locfileid: "119304274"
---
# <a name="is-ephemeral-attribute"></a>Атрибут Is-Ephemeral

Атрибут с **временным** использованием в настоящее время не используется.
...
|-------------------|--------------------------------------|
| CN                | Is-Ephemeral                         |
| LDAP-отображаемое имя | Эфемерный                          |
| Размер              | \-                                   |
