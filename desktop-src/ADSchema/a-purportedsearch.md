...
ms.locfileid: "119923284"
---
# <a name="purported-search-attribute"></a>Атрибут Purported-Search

Аргумент поиска для представления адресной книги.
...
|-------------------|---------------------------------------------|
| CN                | Purported-Search                            |
| LDAP-отображаемое имя | пурпортедсеарч                             |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**Адресная книга-контейнер**](c-addressbookcontainer.md)<br/> |
