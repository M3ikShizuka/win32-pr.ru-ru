...
ms.locfileid: "119300944"
---
# <a name="meetingcontactinfo-attribute"></a>атрибут Митингконтактинфо

Контактные данные собрания.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | митингконтактинфо                          |
| LDAP-отображаемое имя | митингконтактинфо                          |
| Размер              | \-                                          |
