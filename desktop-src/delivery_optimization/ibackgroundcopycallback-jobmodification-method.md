...
description: Оптимизация доставки вызывает реализацию метода Жобмодификатион, когда задание было изменено.
...
ms.locfileid: "128521351"
---
# <a name="ibackgroundcopycallbackjobmodification-method"></a>Метод Ибаккграундкопикаллбакк:: Жобмодификатион

Оптимизация доставки вызывает реализацию метода [**жобмодификатион**](https://www.bing.com/search?q=**JobModification**) , когда задание было изменено. Служба создает это событие, когда передаются байты, в задание добавляются файлы, свойства были изменены или изменилось состояние задания.
...
Содержит методы для доступа к сведениям о свойстве, ходе выполнения и состоянии задания. Не освобождайте *пжоб*; Оптимизация доставки освобождает интерфейс, когда метод [**жобмодификатион**](https://www.bing.com/search?q=**JobModification**) возвращает значение.
