...
| [Консервативная растеризация](conservative-rasterization.md)                                                             | 1 класса ³                    | Необязательно                  | Необязательно                 | Нет                       |
...
| [Контрольное значение трафарета в шейдере](shader-specified-stencil-reference-value.md)                                 | Необязательно                  | Необязательно                  | Необязательно                 | Нет                       |
