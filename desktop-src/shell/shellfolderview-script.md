---
description: Содержит объект скрипта для представления.
ms.assetid: 63a4e42f-3d24-493f-8801-fc09a7477401
title: Свойство Шеллфолдервиев. script (Шлдисп. h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Переменная типа [**IDispatch**](/windows/win32/api/oaidl/nn-oaidl-idispatch) , которая получает объект скрипта.
