---
description: ознакомьтесь с рекомендациями по работе с обработчиками контекстного меню и несколькими глаголами при реализации пользовательского формата файла в оболочке Windows.
