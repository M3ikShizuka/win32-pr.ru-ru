...
В следующем примере используется **имя** для получения имени первого элемента в коллекции команд, на которые реагирует папка программы пользователя. правильное использование отображается для JScript, VBScript и Visual Basic.
